...
草莓;草莓是复活节后最常见的春季爆发作物，种子购买窗口短，越早种越能发挥重复收获优势。第一年不必盲目满田，优先保证每天能浇完，并把第一批收入转化为背包、工具和夏季启动资金。;36px-Strawberry.png;season=春季,days=8,sellPrice=120金,source=复活节,获取方式=春季13日复活节商店购买草莓种子后种植。第一年购买时间偏晚，节日前提前翻地和准备稻草人能减少浪费,主要用途=推荐用于第一年春季现金流，后续可通过种子生产器扩种，也能作为部分村民礼物。适合为夏季蓝莓、洒水器和背包升级积累本金,新手建议=第一年草莓数量以能稳定浇完为上限。不要为了追求收益把体力锁死，否则会拖慢钓鱼、下矿和社区中心进度,关联规划=草莓收益强依赖播种日和收获次数，建议在购买前用收益计算器估算地块规模,links=/guides/beginner|/guides/money-making|/guides/year-one-spring-money-route|/tools/crop-profit|/wiki/crops
...
蓝莓;蓝莓是第一年夏季最稳定的多次收获作物之一，成熟后能持续产出，适合普通新手建立夏季现金流。它不要求复杂加工，但地块过大仍会带来浇水压力。;36px-Blueberry.png;season=夏季,days=13,sellPrice=50金,source=皮埃尔杂货店,获取方式=夏季从皮埃尔杂货店购买种子后种植，成熟后可多次收获。夏1及时下种能显著提高整季收益,主要用途=推荐用于夏季稳定现金流，支持背包升级、洒水器制作、鸡舍畜棚和秋季启动资金。也可作为后续加工和种子生产器过渡材料,新手建议=适合作为第一年夏季主力作物之一，但不要忽略洒水器和矿洞材料。能稳定浇完的地块比盲目扩大更重要,关联规划=建议和甜瓜、啤酒花、辣椒一起用作物收益计算器比较剩余天数、地块数量和加工能力,links=/guides/money-making|/guides/year-one-summer-money-route|/guides/crop-profit-calculator-guide|/tools/crop-profit|/wiki/crops
...
杨桃;杨桃是夏季高价值作物，直接出售已经很强，配合小桶酿酒后是中后期重要收益来源。它种子成本较高，适合有沙漠、洒水器和加工能力后集中规划。;36px-Starfruit.png;season=夏季,days=13,sellPrice=750金,source=绿洲,获取方式=修复巴士后在沙漠绿洲购买杨桃种子，夏季种植。成熟时间较长且种子昂贵，播种前要确认资金和剩余天数,主要用途=推荐用于高价值出售和小桶酿酒，是温室、姜岛和中后期加工路线的重要作物。少量也可用于任务和收藏,新手建议=第一年夏季如果资金、浇水和小桶都不足，不必强行大规模种杨桃。先保证蓝莓、甜瓜和洒水器路线更稳,关联规划=适合和温室加工路线、作物收益计算器一起使用，比较直接出售与酿酒的节奏,links=/guides/money-making|/guides/resources|/guides/greenhouse-crops-processing-route|/tools/crop-profit|/wiki/crops
...
南瓜;南瓜是秋季高价值作物，成熟较慢但单次出售价值高，并可参与社区中心、料理和巨大作物规划。它适合稳定地块种植，不适合临近月底盲目补种。;36px-Pumpkin.png;season=秋季,days=13,sellPrice=320金,source=皮埃尔杂货店,获取方式=秋季从皮埃尔杂货店购买种子后种植。成熟周期较长，播种前要确认秋季剩余天数,主要用途=推荐用于社区中心秋季作物收集包、品质作物规划、送礼和料理，也可尝试巨大作物,新手建议=第一年建议至少保留普通品质和高品质样本。若资金紧张，可以和蔓越莓分配地块，不必全押南瓜,关联规划=适合在秋季赚钱路线中用收益计算器比较南瓜与蔓越莓的现金回收节奏,links=/guides/community-center|/guides/money-making|/guides/year-one-fall-money-route|/tools/community-center|/wiki/crops
...
远古水果;远古水果是温室和姜岛长期种植的核心作物，成熟慢但维护频率低，适合配合小桶形成稳定现金流。新手拿到第一批远古种子后，建议先扩种，不要急着全部出售。;36px-Ancient_Fruit.png;season=春季|夏季|秋季,days=28,sellPrice=550金,source=远古种子,获取方式=远古种子种植后收获，后续可用种子生产器扩种。户外只能在春夏秋种植，温室和姜岛适合长期保留,主要用途=推荐用于温室和姜岛长期种植、小桶酿酒与后期稳定收益。第一批产物通常更适合转化为更多种子,新手建议=建议保留第一批产物用于扩种，产量稳定后再出售或加工。不要因为单价高就过早卖掉种源,关联规划=适合用作物收益计算器比较地块数量、季节剩余天数和加工设备容量,links=/guides/resources|/guides/money-making|/guides/greenhouse-crops-processing-route|/guides/crop-profit-calculator-guide|/tools/crop-profit
...
蓝铁饼鱼;蓝铁饼鱼是姜岛河流中的稀有鱼类，属于后期岛屿图鉴与鱼塘规划内容。它不影响第一年社区中心主线，适合在核桃探索、岛屿农场和火山路线稳定后顺手补齐。;36px-Blue_Discus.png;season=全部,location=姜岛河流,weather=任意,time=全天,获取方式=解锁姜岛后在岛屿河流中钓鱼获得。先确认站位属于河流水域，再配合岛屿探索安排，不需要为它单独往返,主要用途=推荐用于鱼类图鉴、姜岛收集与后期鱼塘规划。第一条适合保留，确认收藏和鱼塘需求后再决定是否出售,新手建议=未解锁姜岛时不用提前追求。到岛后把钓鱼与金色核桃、岛屿农场和火山日程放在一起，效率更高,关联规划=属于后期稀有鱼路线，适合从资源获取与姜岛攻略继续阅读,links=/guides/resources|/guides/ginger-island-golden-walnut-route|/guides/fishing-topic-guide|/tools/fish|/wiki/fish
传说之鱼;传说之鱼是春季雨天出现的传奇鱼之一，挑战前需要同时确认季节、天气、地点和钓鱼能力。它更适合作为钓鱼等级与装备成熟后的收藏目标，而不是新档前几天的赚钱项目。;36px-Legend.png;season=春季,location=山区湖泊,weather=雨天,time=全天,获取方式=春季雨天前往山区湖泊，在满足传奇鱼出现条件的位置钓取。建议提前准备钓鱼增益料理和合适渔具，避免浪费少见的雨天窗口,主要用途=推荐用于传奇鱼收藏、鱼类图鉴与高难度钓鱼挑战。基础传奇鱼每个存档机会有限，第一条应优先保留而不是当作普通鱼出售,新手建议=钓鱼等级较低时先练普通鱼，不要在春季早期把所有雨天都耗在挑战鱼王上。条件成熟后再集中尝试更稳,关联规划=先用查询器确认窗口，再按传奇鱼专题与稀有资源路线准备料理、浮标和当天行程,links=/guides/fishing-topic-guide|/guides/resources|/guides/all-fish-season-weather-reference|/tools/fish|/wiki/fish
绯红鱼;绯红鱼是夏季传奇鱼，地点要求比普通海鱼更特殊。挑战重点不是反复换海滩位置，而是先确认对应区域已经可到达，并为快速移动的鱼准备足够钓鱼等级和控制手段。;36px-Crimsonfish.png;season=夏季,location=东码头,weather=任意,time=全天,获取方式=夏季前往海滩东侧对应码头区域，在正确抛竿位置挑战。出发前确认通路、鱼竿、料理和浮标准备完整,主要用途=推荐用于传奇鱼收藏、图鉴补全和高难度钓鱼挑战。它不是社区中心必需鱼，收藏价值通常高于短期出售价值,新手建议=第一年夏季建设压力大时不必强求。先保证作物、洒水器和基础钓鱼等级，再选农活较少的一天集中挑战,关联规划=适合与夏季专题、钓鱼专题和资源获取攻略一起安排，避免挤占关键农场日程,links=/guides/fishing-topic-guide|/guides/resources|/guides/summer-season-topic-guide|/tools/fish|/wiki/fish
鮟鱇鱼;鮟鱇鱼是秋季传奇鱼，出现区域容易和普通河流钓点混淆。它适合作为秋季中后段的收藏挑战，出发前先确认站位和钓鱼准备，不要只凭鱼名在任意水域反复尝试。;36px-Angler.png;season=秋季,location=木板桥北侧,weather=任意,time=全天,获取方式=秋季前往木板桥北侧对应水域，在正确位置抛竿获得。天气限制相对宽松，可挑农场事务较少的一天挑战,主要用途=推荐用于传奇鱼收藏、鱼类图鉴与高难度钓鱼成就规划。第一条建议长期保留，不与普通秋季鱼混放后误卖,新手建议=秋季还有温室前置和社区中心补漏任务，先处理季节限定献祭，再安排鱼王挑战。准备专门鱼箱保存稀有鱼更安全,关联规划=适合与秋季专题、钓鱼专题和鱼类查询器配合，先排除站位与季节错误,links=/guides/fishing-topic-guide|/guides/resources|/guides/fall-season-topic-guide|/tools/fish|/wiki/fish
冰川鱼;冰川鱼是冬季传奇鱼，以快速移动和较高操作压力著称。冬季农活较少，适合把钓鱼增益、浮标和多次尝试集中到同一天，但仍要留意正确水域和返程时间。;36px-Glacierfish.png;season=冬季,location=箭头岛,weather=任意,time=全天,获取方式=冬季前往箭头岛附近对应钓点，在正确水域挑战。建议携带提高钓鱼能力的料理、恢复食物和备用渔具,主要用途=推荐用于传奇鱼收藏、冬季图鉴补全与高难度钓鱼挑战。捕获后应单独保存，避免整理箱子时当成普通冬季鱼出售,新手建议=如果连续失败，先升级钓鱼等级并练习快速鱼的短按控制，不必用整季时间硬拼。冬季也要兼顾矿洞和第二年准备,关联规划=适合与冬季专题、钓鱼专题和资源获取攻略一起规划，使用冬季空档完成挑战,links=/guides/fishing-topic-guide|/guides/resources|/guides/winter-season-topic-guide|/tools/fish|/wiki/fish
变种鲤鱼;变种鲤鱼是下水道区域的传奇鱼，难点首先在地点解锁，其次才是钓鱼操作。尚未进入下水道时不用反复搜索普通河流，先推进博物馆与相关解锁路线。;36px-Mutant_Carp.png;season=全部,location=下水道,weather=任意,time=全天,获取方式=解锁下水道后在当地水域钓鱼获得。它不受普通季节窗口限制，适合在区域开放且钓鱼准备成熟后安排,主要用途=推荐用于传奇鱼收藏、鱼类图鉴和后期补全。因为解锁成本和收藏价值较高，第一条不建议直接出售,新手建议=新档前期先推进基础建设和博物馆捐赠，不必把它列为第一年早期目标。进入下水道后再用查询器复核条件,关联规划=它同时属于解锁路线和稀有鱼路线，适合从资源获取攻略继续查看前置与准备,links=/guides/resources|/guides/fishing-topic-guide|/wiki/locations/krobus-icon|/tools/fish|/wiki/fish
虾虎鱼;虾虎鱼是 1.6 版本加入的瀑布鱼类，地点比季节更容易成为误区。它属于特殊水域图鉴目标，先找到正确瀑布钓点，再考虑鱼竿和操作，不要在普通森林河流反复尝试。;36px-Goby.png;season=全部,location=煤矿森林瀑布,weather=任意,time=全天,获取方式=前往煤矿森林瀑布对应水域，在正确抛竿位置钓鱼获得。出现条件相对宽松，但水域位置必须准确,主要用途=推荐用于 1.6 鱼类图鉴补全、特殊鱼收藏和后期查漏。第一条建议保留，避免之后因站位问题再次专程寻找,新手建议=普通新手可以等基础钓鱼路线稳定后再补。找不到时先核对地点图片或位置说明，不要只提高钓鱼等级,关联规划=适合与鱼类查询器、钓鱼专题和资源获取攻略一起使用，按特殊地点逐一补齐,links=/guides/fishing-topic-guide|/guides/resources|/guides/all-fish-season-weather-reference|/tools/fish|/wiki/fish
`),
  ...rows("villagers", `
...
苹果;苹果是秋季果树水果，主要价值不在短期出售，而在社区中心、料理和送礼规划。果树需要提前种下并等待成长，适合把温室边缘或农场长期空位规划出来。;36px-Apple.png;type=果树水果,source=苹果树|温室果树,sellPrice=随品质变化,获取方式=种下苹果树苗并等待果树成熟后，在秋季或温室内采收。果树周围需要保持空位，室外种植要提前考虑季节和建筑布局,主要用途=用于社区中心相关收集、料理和部分村民礼物。温室边缘种植后可作为长期水果来源，不占用中间作物地块,新手建议=第一批苹果建议保留，不要只按售价处理。若准备走社区中心路线，提前记录果树需求，避免等到秋季后才发现缺样本,关联规划=适合和温室果树布局、社区中心清单、季节留物清单一起查看,links=/guides/greenhouse-fruit-tree-planning|/tools/community-center|/guides/seasonal-items-to-keep|/wiki/items
杏子;杏子是春季果树水果，常用于料理和早期收集规划。它不是第一年最急的赚钱来源，但如果已经准备长期果树区，提前种下能减少后续等待。;36px-Apricot.png;type=果树水果,source=杏树|温室果树,sellPrice=随品质变化,获取方式=种下杏树苗并等待成熟后，在春季或温室内采收。果树成长期间周围空位不能被杂物、地板或设备阻挡,主要用途=用于料理、图鉴补全和部分收集需求。温室种植后可以全年取得样本，减少季节等待,新手建议=前期资金紧张时不必优先买杏树，但一旦开始规划果树，第一批杏子建议留样本，不要全部出售,关联规划=适合和温室果树布局、料理图鉴、季节留物清单一起安排,links=/guides/greenhouse-fruit-tree-planning|/guides/seasonal-items-to-keep|/wiki/cooking|/wiki/items
樱桃;樱桃是春季果树水果，适合补图鉴、送礼和长期水果储备。它的收益节奏慢于普通作物，因此更适合作为温室边缘或农场固定果树区的一部分。;36px-Cherry.png;type=果树水果,source=樱桃树|温室果树,sellPrice=随品质变化,获取方式=种下樱桃树苗并等待成熟后，在春季或温室内采收。室外种植要预留一整月成长时间，温室种植则更适合长期规划,主要用途=用于水果储备、礼物和图鉴补全。多余水果可直接出售，也可作为后续加工和料理材料,新手建议=不要把果树当成第一年春季现金流核心。更稳的做法是先保证作物、背包和矿洞，再逐步补果树,关联规划=适合和温室果树布局、第一年春季路线、礼物推荐一起规划,links=/guides/greenhouse-fruit-tree-planning|/guides/year-one-spring-money-route|/guides/villager-gift-birthday-recommendation|/wiki/items
橙子;橙子是夏季果树水果，常用于送礼和中期水果库存。它适合在农场现金流稳定后种下，或放进温室边缘作为全年采收来源。;36px-Orange.png;type=果树水果,source=橙子树|温室果树,sellPrice=随品质变化,获取方式=种下橙子树苗并等待成熟后，在夏季或温室内采收。果树需要提前规划位置，避免被道路、设备或自然杂物阻挡成长,主要用途=用于送礼、图鉴补全和长期水果储备。温室中种植可减少夏季限定带来的等待,新手建议=第一年夏季如果资金主要用于蓝莓、洒水器和背包，橙子树可以延后。买下后优先保证果树周围空位干净,关联规划=适合和夏季赚钱路线、温室果树布局、礼物推荐一起查看,links=/guides/year-one-summer-money-route|/guides/greenhouse-fruit-tree-planning|/guides/villager-gift-birthday-recommendation|/wiki/items
桃子;桃子是夏季果树水果，常用于送礼和后期水果库存。由于树苗成本和成长等待较高，它更适合中期稳定后纳入温室或固定果园。;36px-Peach.png;type=果树水果,source=桃子树|温室果树,sellPrice=随品质变化,获取方式=种下桃子树苗并等待成熟后，在夏季或温室内采收。室外种植要确保提前一个季节规划，温室内则能全年持续取得,主要用途=用于送礼、收集和水果库存。多余桃子可作为普通水果资源处理，但第一批应先确认礼物和收集需求,新手建议=不要为了桃子树牺牲第一年夏季基础建设。等洒水器、矿洞和背包稳定后，再把树苗加入长期规划,关联规划=适合和温室果树布局、夏季赚钱路线、背包体力路线一起安排,links=/guides/greenhouse-fruit-tree-planning|/guides/year-one-summer-money-route|/guides/beginner-backpack-and-energy-route|/wiki/items
石榴;石榴是秋季果树水果，常见于送礼和社区中心相关规划。它的价值主要在于提前准备，避免秋季错过后又要等待下一年。;36px-Pomegranate.png;type=果树水果,source=石榴树|温室果树,sellPrice=随品质变化,获取方式=种下石榴树苗并等待成熟后，在秋季或温室内采收。室外种植时应提前一个季节决定位置，温室种植可以减少季节限制,主要用途=用于送礼、收集和长期水果储备。对于人物关系和社区中心路线都有实用价值,新手建议=第一批石榴建议保留至少一份。若资金紧张，可以先完成社区中心和洒水器路线，再安排果树投入,关联规划=适合和温室果树布局、礼物推荐、社区中心清单一起规划,links=/guides/greenhouse-fruit-tree-planning|/guides/villager-gift-birthday-recommendation|/tools/community-center|/wiki/items
香蕉;香蕉是姜岛相关果树水果，更偏后期内容。它适合岛屿推进后纳入水果储备和送礼路线，不是第一年农场必须追求的目标。;36px-Banana.png;type=果树水果,source=香蕉树|姜岛|温室果树,sellPrice=随品质变化,获取方式=取得香蕉树苗后种植，成熟后可在适合环境中采收。通常和姜岛推进、后期资源整理联系更紧密,主要用途=用于岛屿内容、送礼和长期水果库存。它能补足后期图鉴和人物关系路线,新手建议=未解锁姜岛前不用为香蕉预留太多计划。进入岛屿阶段后，再把香蕉树和芒果树一起纳入后期果树规划,关联规划=适合和姜岛核桃路线、温室果树布局、礼物推荐一起查看,links=/guides/ginger-island-golden-walnut-route|/guides/greenhouse-fruit-tree-planning|/guides/villager-gift-birthday-recommendation|/wiki/items
...
`),
  ...rows("quests", `
社区中心;修复鹈鹕镇社区中心的长期主线;36px-Junimo.png;type=主线,trigger=进入社区中心,reward=修复城镇设施,获取方式=春季进入鹈鹕镇触发社区中心事件后开启。跟随刘易斯进入废弃建筑，再等待法师来信即可查看收集包,主要用途=通过收集作物、鱼类、动物产品、矿物和工匠品逐步修复城镇设施，是社区中心路线的核心长期目标,新手建议=第一年不要乱卖季节限定物品。每个季节先留一份作物、鱼和采集物，再把多余物品出售,关联规划=适合用社区中心清单按房间和季节排查缺口，同时配合作物和鱼类资料库避免漏献祭,links=/tools/community-center|/wiki/crops|/wiki/fish|/guides/early-community-center-priority-route
Joja 发展申请书;付费完成城镇项目的替代路线;36px-Joja_Cola.png;type=主线,trigger=购买会员,reward=城镇设施,获取方式=前往 Joja 超市购买会员后开启。之后通过付款直接完成矿车、温室、巴士、桥梁等城镇项目,主要用途=用金币替代收集包，快速解锁设施。适合不想管理献祭物品或想走效率路线的存档,新手建议=选择前确认是否接受放弃社区中心剧情。前期仍要保留作物和鱼类样本，因为任务、料理和送礼仍会用到,关联规划=适合和作物收益路线、矿洞材料路线一起规划现金流，避免为了付款而卖掉关键生产材料,links=/tools/crops|/guides/year-one-summer-money-route|/guides/sprinkler-unlock-and-ore-route|/wiki/locations
神秘的齐;解锁赌场的系列任务;36px-Mr._Qi_Icon.png;type=系列任务,trigger=隧道电池箱,reward=赌场会员卡,获取方式=取得电池组后在巴士隧道的电池箱触发线索，按提示完成后续投放和交付步骤，最终解锁赌场会员卡,主要用途=开启赌场与齐先生早期相关内容，也让玩家熟悉跨区域线索任务和隐藏地点排查,新手建议=不要把第一批电池组全部用于送礼或出售。避雷针稳定前，至少保留一组电池用于任务和建设,关联规划=适合在巴士修复、沙漠探索和姜岛前置之间衔接，和保留物品清单一起检查关键材料,links=/guides/seasonal-items-to-keep|/wiki/locations|/guides/ginger-island-golden-walnut-route|/wiki/items
哥布林问题;进入女巫沼泽并取回魔法墨水;36px-Void_Mayonnaise.png;type=主线,trigger=黑暗护符,reward=魔法建筑,获取方式=完成相关主线后取得黑暗护符并前往女巫沼泽。用哥布林喜欢的物品通过守卫后取回魔法墨水,主要用途=解锁法师处的魔法建筑，服务后期农场调整、传送建筑和布局优化,新手建议=这是中后期任务，不需要第一年硬赶。前期重点仍是社区中心、矿洞、背包和稳定收入,关联规划=适合在完成主线设施、准备后期农场布局和传送系统时处理，和地点资料一起确认路线,links=/wiki/locations|/guides/winter-prep-year-two-route|/guides/beginner-year-one-route-overview|/wiki/items
海盗的妻子;姜岛物品交换链;36px-War_Memento.png;type=姜岛,trigger=与鸟蒂交谈,reward=仙尘配方,获取方式=抵达姜岛西部后与鸟蒂交谈开启。按线索把纪念品依次交给对应村民，最终完成交换链,主要用途=获得仙尘配方并推进姜岛收集。任务会串联多个村民和地点，是姜岛中期整理的重要内容,新手建议=先解锁岛屿农场和睡眠小屋再做交换链，减少往返。任务物品不要混入出售箱或礼物箱,关联规划=适合和姜岛核桃路线、村民礼物路线、地点资料一起查看，按村民位置安排一天内完成多段交付,links=/guides/ginger-island-golden-walnut-route|/guides/villager-gift-birthday-recommendation|/wiki/villagers|/wiki/locations
齐先生的五彩农场;提交六种颜色各100件物品;36px-Qi_Gem.png;type=齐先生,trigger=核桃房,reward=35齐钻,获取方式=收集足够金色核桃开启核桃房后，从齐先生特别任务板接取。需要在期限内提交六种颜色分类物品,主要用途=获得齐钻并训练玩家建立大批量物品储备。任务适合消耗普通作物、矿物、鱼和可重复取得材料,新手建议=不要临时硬凑稀有物品。平时按颜色保留一部分低成本材料，接到任务后再补缺口,关联规划=适合和温室作物、矿洞掉落、保留物品清单一起规划，把可再生物品优先用于提交,links=/guides/seasonal-items-to-keep|/guides/greenhouse-crops-processing-route|/guides/mines-drops-and-floor-resource-route|/wiki/items
深处的危险;一周内再次抵达矿井底部;36px-Danger_In_The_Deep.png;type=齐先生,trigger=核桃房,reward=50齐钻,获取方式=核桃房开放后从齐先生特别任务板接取。任务期间矿井会变为危险版本，需要在时限内重新推进到底层,主要用途=获取齐钻并解锁更高强度矿洞材料路线。适合已有武器、防具、炸弹和食物储备的玩家挑战,新手建议=没有稳定战斗装备时不要强接。先准备电梯节奏、恢复食物、炸弹和返程时间，避免频繁昏倒损失,关联规划=适合和矿洞前40层、矿洞掉落、洒水器矿石路线衔接，按好运日集中推进,links=/guides/mines-floor-40-preparation-route|/guides/mines-drops-and-floor-resource-route|/guides/sprinkler-unlock-and-ore-route|/wiki/items
罗宾的资源大作战;收集并提交大量木材或石头;36px-Robin_Icon.png;type=特别订单,trigger=特别订单板,reward=石箱配方,获取方式=解锁特别订单板后随机出现。接取后在期限内收集并提交指定数量木材或石头,主要用途=获得石箱配方，并把砍树、采石、矿洞和农场清理转化为阶段性目标,新手建议=接任务前先看当前库存和剩余时间。不要为了任务清空建设材料，鸡舍、畜棚、洒水器和加工设备仍要优先保证,关联规划=适合和矿洞掉落路线、背包体力路线、任务板攻略一起安排，把资源收集日集中处理,links=/guides/quest-board-special-orders-route|/guides/mines-drops-and-floor-resource-route|/guides/beginner-backpack-and-energy-route|/wiki/locations
`),
  ...rows("festivals", `
复活节;参加彩蛋大寻宝并购买草莓种子;36px-Strawberry.png;season=春季,date=13日,location=鹈鹕镇,获取方式=春季13日上午进入鹈鹕镇参加。节日开始后当天商店和常规地点会关闭，活动结束直接回到夜晚,主要用途=购买草莓种子并参加彩蛋大寻宝。草莓是第一年春季后半段的重要现金作物，适合提前准备土地和本金,新手建议=节日前一晚先翻地、浇水并准备稻草人覆盖。第一年购买数量以能稳定浇完为上限，不必追求满田,关联规划=适合和春季赚钱路线、作物收益计算器、作物图鉴一起规划草莓播种规模,links=/guides/year-one-spring-money-route|/tools/crops|/wiki/crops|/guides/crop-profit-calculator-guide
花舞节;与达到4心的可婚村民跳舞;36px-Tulip.png;season=春季,date=24日,location=煤矿森林,获取方式=春季24日前往煤矿森林参加。需要目标可婚村民达到足够好感，才会同意共舞,主要用途=提升关系并购买部分装饰。对收益影响不大，但能提醒玩家早期送礼和生日规划的重要性,新手建议=第一年没有舞伴很正常，不必强行送昂贵礼物。可以把花舞节当作关系进度检查点,关联规划=适合和村民礼物路线、生日送礼资料、春季日程一起规划，把送礼安排到正常跑图路线中,links=/guides/villager-gift-birthday-recommendation|/wiki/villagers|/guides/beginner-year-one-route-overview|/guides/year-one-spring-money-route
夏威夷宴会;向百乐汤加入食材接受评价;36px-Soup.png;season=夏季,date=11日,location=海滩,获取方式=夏季11日前往海滩参加。进入活动前准备一件可放入百乐汤的食材，活动期间无法临时回家取物,主要用途=通过投放食材获得州长评价并影响村民好感。高品质作物、鱼和动物产品通常更适合作为贡献物,新手建议=不要随手放低价值或负面物品。第一年可以准备高品质作物或稳定鱼获，实在没有合适食材就保守处理,关联规划=适合和夏季赚钱路线、作物图鉴、鱼类图鉴一起挑选食材，避免误用社区中心关键样本,links=/guides/year-one-summer-money-route|/wiki/crops|/wiki/fish|/guides/seasonal-items-to-keep
月光水母起舞;观看水母迁徙;36px-Moonlight_Jellies_Banner.png;season=夏季,date=28日,location=海滩,获取方式=夏季28日晚前往海滩观看。活动较晚开始，白天仍可正常处理农场、矿洞或钓鱼日程,主要用途=作为夏季收尾事件，没有复杂收集目标。适合在进入秋季前整理箱子、检查现金和材料储备,新手建议=活动前把夏季最后一批作物收好，晚上参加后直接进入秋季。不要把秋季种子和工具准备拖到当天深夜,关联规划=适合和夏季路线、秋季赚钱路线、保留物品清单一起做季末检查,links=/guides/year-one-summer-money-route|/guides/year-one-fall-money-route|/guides/seasonal-items-to-keep|/wiki/locations
星露谷展览会;展示九件物品并游玩小游戏;36px-Star_Token.png;season=秋季,date=16日,location=鹈鹕镇,获取方式=秋季16日前往鹈鹕镇参加。提前准备九件不同类型、高品质或高价值物品用于展览评分,主要用途=通过展览和小游戏获得星星币，兑换星之果实等奖励。它也是检查农场多样化产出的节点,新手建议=不要临时把所有高价值物品卖掉。活动前保留作物、鱼、矿物、动物产品和工匠品各类代表样本,关联规划=适合和秋季路线、保留物品清单、图鉴详情一起准备展示组合,links=/guides/year-one-fall-money-route|/guides/seasonal-items-to-keep|/wiki/crops|/wiki/items
万灵节;探索迷宫获取金色南瓜;36px-Golden_Pumpkin.png;season=秋季,date=27日,location=鹈鹕镇,获取方式=秋季27日晚前往鹈鹕镇参加。沿迷宫隐藏路线前进可取得金色南瓜,主要用途=获得金色南瓜并购买节日装饰。金色南瓜价值较高，也可作为通用喜爱礼物使用,新手建议=第一次参加优先拿金色南瓜，不需要在迷宫里反复尝试其他路线。活动前白天仍可完成正常农场事务,关联规划=适合和秋季路线、村民礼物路线、保留物品清单一起决定金色南瓜是出售还是留作礼物,links=/guides/year-one-fall-money-route|/guides/villager-gift-birthday-recommendation|/guides/seasonal-items-to-keep|/wiki/items
冰雪节;参加冰钓比赛;36px-Perch.png;season=冬季,date=8日,location=煤矿森林,获取方式=冬季8日前往煤矿森林参加。活动中可参加冰钓比赛，使用临时钓点完成限定挑战,主要用途=获得冬季节日奖励并练习短时间钓鱼节奏。对鱼类图鉴影响不大，但适合检查钓鱼手感和增益准备,新手建议=钓鱼等级低也可以参加，不要因为比赛失败影响冬季主线。冬季重点仍是矿洞、工具升级和第二年准备,关联规划=适合和冬季准备路线、鱼类查询器、钓鱼入门攻略一起安排冬季钓鱼练习,links=/guides/winter-prep-year-two-route|/tools/fish|/guides/beginner-fishing-guide-and-fish-search|/wiki/fish
夜市;连续三晚开放的海上市场;36px-Pearl.png;season=冬季,date=15-17日,location=海滩,获取方式=冬季15日至17日晚前往海滩参加。三晚内容相同但可重复访问，潜水艇钓鱼需要单独花时间进入,主要用途=购买稀有商品、观看演出、乘潜水艇钓深海鱼。也是补水滴鱼、午夜鱿鱼等特殊鱼的重要窗口,新手建议=提前留出晚上时间和背包空间。想补图鉴时优先潜水艇，不要被商店和装饰分散全部时间,关联规划=适合和鱼类查询器、鱼缸路线、冬季准备路线一起规划特殊鱼和冬季收入,links=/tools/fish|/guides/community-center-fish-tank-route|/guides/winter-prep-year-two-route|/wiki/fish
冬日星盛宴;秘密送礼活动;36px-Secret_Gift.png;season=冬季,date=25日,location=鹈鹕镇,获取方式=冬季25日前往鹈鹕镇参加。节日前会收到秘密送礼对象，活动当天需要携带礼物进入广场,主要用途=完成年度秘密送礼并获得回礼。高品质最爱礼物能显著提升目标村民好感,新手建议=收到对象后立刻查礼物偏好，把礼物放在门口箱子或背包固定位置，避免节日当天忘带,关联规划=适合和村民礼物路线、NPC资料、保留物品清单一起准备冬季礼物,links=/guides/villager-gift-birthday-recommendation|/wiki/villagers|/guides/seasonal-items-to-keep|/wiki/items
沙漠节;1.6 新增三日沙漠活动;36px-Calico_Egg.png;season=春季,date=15-17日,location=沙漠,获取方式=春季15日至17日在沙漠举行，需要先修复巴士并能前往卡利科沙漠。活动期间沙漠区域会出现特殊摊位和挑战,主要用途=获取活动代币、购买稀有奖励，并把沙漠探索、骷髅洞穴和节日内容结合起来,新手建议=第一年通常不必强求。能参加时先确认背包、食物、传送和返程方式，避免把节日当成普通跑图日,关联规划=适合和沙漠地点、矿洞掉落、春季路线一起规划，尤其适合已有稳定现金和巴士解锁的存档,links=/wiki/locations|/guides/mines-drops-and-floor-resource-route|/guides/year-one-spring-money-route|/wiki/items
鳟鱼大赛;1.6 新增钓鱼活动;36px-Rainbow_Trout.png;season=夏季,date=20-21日,location=煤矿森林,获取方式=夏季20日至21日前往煤矿森林参加。活动围绕虹鳟鱼钓取与奖励兑换展开,主要用途=集中练钓鱼、获取活动奖励，并为夏季鱼类图鉴和鱼缸缺口补进度,新手建议=参加前准备鱼饵、食物和背包空间。若当天还有重要作物收获，先处理农场再去比赛,关联规划=适合和鱼类查询器、夏季赚钱路线、鱼缸路线一起安排，避免错过夏季雨天和夜间鱼窗口,links=/tools/fish|/guides/year-one-summer-money-route|/guides/community-center-fish-tank-route|/wiki/fish
鱿鱼节;1.6 新增冬季钓鱼活动;36px-Squid.png;season=冬季,date=12-13日,location=海滩,获取方式=冬季12日至13日前往海滩参加。活动目标围绕鱿鱼钓取和奖励阶段展开,主要用途=补冬季钓鱼练习和活动奖励，也能顺带检查海滩鱼类与夜间鱼准备,新手建议=冬季农场维护少，适合把晚上留给钓鱼。钓鱼等级低时准备增益料理，先保证稳定上鱼,关联规划=适合和夜市、鱼类查询器、冬季准备路线搭配，把冬季钓鱼窗口统一处理,links=/tools/fish|/guides/winter-prep-year-two-route|/guides/beginner-fishing-guide-and-fish-search|/wiki/fish
`),
  ...rows("locations", `
农场;玩家经营和建设的核心区域;36px-Farmhouse.png;area=山谷西部,open=全天,features=耕种|畜牧|建筑,获取方式=开局即可使用，是玩家睡觉、种植、养殖、建造和存放物品的核心地点,主要用途=承担作物收益、动物产品、加工设备、建筑布局和长期资源储备。多数日程都从农场出发再回到农场整理,新手建议=前期不要一次清空全图。先围绕农舍建立箱子、作物区和稻草人覆盖，逐步扩展到动物和加工区,关联规划=适合和作物收益、背包体力、第一年路线一起规划，把每天维护时间控制在可接受范围内,links=/tools/crops|/guides/beginner-backpack-and-energy-route|/guides/beginner-year-one-route-overview|/wiki/crops
鹈鹕镇;商店和多数居民所在地;36px-Town.png;area=山谷中心,open=全天,features=商店|任务|节日,获取方式=从农场东侧进入即可到达。镇上分布皮埃尔杂货店、诊所、公告板、社区中心和多数居民住宅,主要用途=购买种子、接任务、查看日历、送礼、参加节日和推进社区中心主线，是前期最频繁往返的公共区域,新手建议=每天路过时看一次公告板和日历。背包小的时候把镇中心行程和购物、送礼、任务提交合并处理,关联规划=适合和村民礼物、任务指南、社区中心路线一起安排，减少无效跑图,links=/guides/villager-gift-birthday-recommendation|/guides/quest-board-special-orders-route|/tools/community-center|/wiki/villagers
海滩;鱼店、潮池和海洋钓鱼区;36px-Beach.png;area=山谷南部,open=全天,features=钓鱼|采集|节日,获取方式=从鹈鹕镇南侧进入海滩。修复木桥后可进入潮池区域，威利鱼店也在此处,主要用途=海洋钓鱼、购买鱼竿、采集珊瑚和海胆、参加夏威夷宴会、夜市和部分钓鱼活动,新手建议=第二天领取鱼竿后可以常来练级。早期修桥能增加每日采集收益，但不要因此卖掉社区中心需要的鱼,关联规划=适合和鱼类查询器、鱼缸路线、夜市和钓鱼入门攻略一起使用,links=/tools/fish|/guides/beginner-fishing-guide-and-fish-search|/guides/community-center-fish-tank-route|/wiki/fish
山区;矿井、湖泊和木匠商店区域;36px-Mountain.png;area=山谷北部,open=全天,features=矿井|湖泊|木匠,获取方式=从农场北侧或镇北部进入山区。这里连接矿井、木匠商店、湖泊、冒险家公会和铁路区域,主要用途=推进矿洞、钓湖鱼、购买和升级建筑，并处理罗宾相关订单和资源路线,新手建议=把山区日程合并处理：下矿前顺路交建筑材料，矿洞结束后整理鱼和矿石，减少来回跑,关联规划=适合和矿洞前40层、洒水器矿石路线、背包体力路线一起规划每日目标,links=/guides/mines-floor-40-preparation-route|/guides/sprinkler-unlock-and-ore-route|/guides/beginner-backpack-and-energy-route|/wiki/items
矿井;共120层的采矿和战斗区域;36px-Mining_Skill_Icon.png;area=山区,open=全天,features=矿石|怪物|电梯,获取方式=春季第5日矿井入口开放后进入。每推进5层会保存电梯节点，方便之后从已到达楼层继续,主要用途=获取铜矿、铁矿、金矿、煤炭、晶球、怪物掉落和战斗经验，是洒水器、工具升级和加工设备的材料来源,新手建议=每次以5层为小目标，不要把目标设成清空整层。晚上提前返程，背包留空位给矿石和怪物掉落,关联规划=适合和矿洞掉落路线、洒水器解锁、背包体力路线一起规划，决定什么时候扩田和升级工具,links=/guides/mines-floor-40-preparation-route|/guides/mines-drops-and-floor-resource-route|/guides/sprinkler-unlock-and-ore-route|/wiki/items
沙漠;修复巴士后开放;36px-Desert.png;area=卡利科沙漠,open=10:10-23:50,features=绿洲|骷髅洞穴|沙漠节,获取方式=修复巴士后在白天乘车前往。沙漠包含绿洲商店、骷髅洞穴入口和部分特殊任务地点,主要用途=购买沙漠作物种子、进入骷髅洞穴、参加沙漠节并推进齐先生相关内容,新手建议=第一次去沙漠不要只购物。确认带够金币、食物、传送或返程时间，骷髅洞穴探索需要比普通矿井更充分准备,关联规划=适合和春季作物大黄、矿洞掉落、沙漠节和齐先生任务一起规划,links=/wiki/crops|/guides/mines-drops-and-floor-resource-route|/wiki/festivals|/wiki/quests
下水道;捐赠60件博物馆藏品后开放;36px-Krobus_Icon.png;area=地下,open=全天,features=科罗布斯|变种虫穴,获取方式=向博物馆捐赠足够藏品后获得生锈钥匙，从镇上或煤矿森林入口进入下水道,主要用途=访问科罗布斯商店、进入变种虫穴并获取部分特殊鱼和任务内容,新手建议=早期遇到首件矿物和文物优先捐赠，不要全部出售。解锁后定期查看科罗布斯商品和任务需求,关联规划=适合和博物馆收集、鱼类查询、任务指南一起查看，尤其是补变种鲤鱼和后期任务时,links=/tools/fish|/wiki/fish|/wiki/quests|/guides/seasonal-items-to-keep
秘密森林;升级钢斧后可进入;36px-Hardwood.png;area=煤矿森林,open=全天,features=硬木|木跃鱼|雕像,获取方式=将斧头升级到钢斧后砍开煤矿森林西北侧的大木桩进入，之后全天可访问,主要用途=每日获取硬木、钓木跃鱼、完成雕像相关内容，并为马厩、建筑和姜岛前置储备硬木,新手建议=钢斧升级后尽早加入日常路线。硬木不要全部卖掉，姜岛船只修复和建筑都会大量需要,关联规划=适合和姜岛解锁、鱼类图鉴、冬季准备路线一起安排，把硬木和特殊鱼提前储备,links=/guides/ginger-island-golden-walnut-route|/tools/fish|/guides/winter-prep-year-two-route|/wiki/items
姜岛;修复威利的船后开放;36px-Golden_Walnut.png;area=蕨岛群岛,open=全天,features=核桃|火山|岛屿农场,获取方式=完成社区中心或 Joja 项目后，修复威利鱼店后方的船只即可乘船前往,主要用途=收集金色核桃、解锁岛屿农场、探索火山地牢、推进鸟蒂任务和齐先生核桃房,新手建议=首次登岛先解锁西部农场和睡眠小屋，不要随意花费核桃。背包准备食物、喷壶和采集工具,关联规划=适合和姜岛核桃路线、海盗的妻子任务、火山地牢资料一起推进,links=/guides/ginger-island-golden-walnut-route|/wiki/quests|/wiki/locations|/wiki/items
火山地牢;姜岛十层地牢;36px-Volcano_Dungeon.png;area=姜岛北部,open=全天,features=锻造台|龙牙|火山晶石,获取方式=抵达姜岛北部后进入。用喷壶浇灭岩浆开路，推进到第十层后可使用锻造台并开启快捷出口,主要用途=获取火山晶石、龙牙、锻造和附魔材料，是后期武器、工具和戒指强化的重要地点,新手建议=不要空手进入。准备喷壶、食物、炸弹和返程时间，第五层商店和第十层锻造台是关键节点,关联规划=适合和姜岛路线、矿洞掉落、精通系统和后期装备规划一起查看,links=/guides/ginger-island-golden-walnut-route|/guides/mines-drops-and-floor-resource-route|/guides/mastery-system-guide-1-6|/wiki/items
齐先生的核桃房;收集100个金色核桃后开放;36px-Qi_Gem.png;area=姜岛西部,open=全天,features=特别任务|齐钻商店,获取方式=累计收集100个金色核桃后在姜岛西部开放。进入后可查看完美度、接齐先生特别任务并兑换齐钻商店物品,主要用途=推进后期挑战、完美度、齐钻奖励和特殊装备。它把矿洞、钓鱼、料理、种植和收集都变成高级目标,新手建议=先建立稳定收入和岛屿交通，再处理核桃房任务。接任务前确认库存和时间，不要临时硬凑稀有材料,关联规划=适合和齐先生任务、姜岛核桃路线、保留物品清单和矿洞掉落路线一起规划,links=/wiki/quests|/guides/ginger-island-golden-walnut-route|/guides/seasonal-items-to-keep|/guides/mines-drops-and-floor-resource-route
精通洞窟;五项技能满级后开放;36px-Mastery_Cave.png;area=煤矿森林,open=全天,features=精通奖励,获取方式=耕种、采矿、采集、钓鱼和战斗五项技能全部达到10级后，在煤矿森林开放精通洞窟,主要用途=消耗后续技能经验解锁五类精通奖励，包括高级工具、设备、雕像和后期效率系统,新手建议=这是后期内容，第一年不用强追。前期先把技能自然提升，满级后再按当前瓶颈选择精通奖励,关联规划=适合和精通系统攻略、矿洞路线、作物收益和背包体力规划一起查看，决定第一项精通优先级,links=/guides/mastery-system-guide-1-6|/guides/mines-floor-40-preparation-route|/tools/crops|/guides/beginner-backpack-and-energy-route
`),
  ...rows("cooking", `
炒鳗鱼;适合下矿、开晶球和刷稀有掉落的运气料理;36px-Fried_Eel.png;source=电视料理频道或配方解锁,ingredients=鳗鱼|油,energy=恢复体力并提供运气增益,获取方式=先解锁炒鳗鱼配方，再准备鳗鱼和油制作。鳗鱼受季节、天气和时间限制，建议先用鱼类查询器确认捕获窗口,主要用途=下矿、开晶球、刷稀有掉落和姜岛探索前使用，运气增益能让资源路线更稳定，也可作为鱼类料理图鉴补全目标,新手建议=第一条鳗鱼不要急着做料理，先确认社区中心鱼缸和图鉴需求。材料充足后再批量准备，用在下矿或重要探索日更划算,关联规划=适合和鱼类查询器、矿洞掉落路线、社区中心鱼缸路线一起使用，先确定鱼类获取时间再安排料理库存,links=/tools/fish|/guides/community-center-fish-tank-route|/guides/mines-drops-and-floor-resource-route|/wiki/fish
炸鱿鱼;兼顾料理图鉴、送礼和海鲜库存管理的鱿鱼料理;36px-Fried_Calamari.png;source=料理配方解锁后制作,ingredients=鱿鱼|小麦粉|油,energy=恢复体力,获取方式=解锁炸鱿鱼配方后，用鱿鱼、小麦粉和油在厨房制作。鱿鱼通常需要按季节、时间和地点提前捕获，不适合临时需要时才找,主要用途=用于料理图鉴、部分村民送礼和体力补给，也能把多余鱿鱼转化为更明确的用途，避免鱼类库存混乱,新手建议=如果还没有完成鱼类图鉴或社区中心相关目标，先保留鱿鱼样本。小麦粉和油有成本，前期不要为了普通补体力大量制作,关联规划=适合和鱼类查询器、礼物推荐、料理配方图鉴一起查看，确认鱿鱼是否还有献祭、任务或送礼用途,links=/tools/fish|/guides/villager-gift-birthday-recommendation|/wiki/cooking|/wiki/fish
寿司卷;用普通鱼、海草和大米整理鱼类库存的基础料理;36px-Maki_Roll.png;source=电视料理频道或星之果实餐吧,ingredients=任意鱼|海草|大米,energy=恢复体力,获取方式=解锁寿司卷配方后，用任意鱼、海草和大米制作。配方可通过电视料理频道或其他游戏内来源获得，材料相对常见但仍要提前储备,主要用途=用于料理收集、部分任务和礼物，也适合消耗低价值鱼类。它能把普通鱼转成更统一的料理库存，方便长期管理,新手建议=不要把季节限定鱼或社区中心鱼拿去做寿司卷。优先使用容易重复获得的普通鱼，并保留海草给鱼塘或后续需求,关联规划=适合和鱼类查询器、社区中心清单、保留物品清单一起使用，先确认鱼类是否可卖或可加工,links=/tools/fish|/tools/community-center|/guides/seasonal-items-to-keep|/wiki/cooking
煎蛋;鸡舍稳定后最容易补充的厨房基础体力料理;36px-Fried_Egg.png;source=厨房基础料理,ingredients=鸡蛋,energy=恢复体力,获取方式=拥有厨房后使用鸡蛋制作。鸡蛋来自鸡舍动物，稳定产出后煎蛋会成为最容易补充的基础料理之一,主要用途=用于料理图鉴、部分食谱材料衔接和前期体力补给。它不是高收益加工路线，但能帮助玩家理解动物产品、厨房和料理库存的关系,新手建议=前期鸡蛋通常优先用于动物产品收集、送礼或加工判断。鸡舍稳定后再把多余鸡蛋做成煎蛋，不要影响社区中心动物产品目标,关联规划=适合和动物产品路线、料理配方图鉴、背包体力管理一起查看，判断鸡蛋是卖、送、加工还是做料理,links=/guides/coop-barn-animal-products-route|/guides/beginner-backpack-and-energy-route|/wiki/cooking|/tools/community-center
海泡布丁;挑战高难度鱼和传奇鱼前准备的进阶钓鱼料理;36px-Seafoam_Pudding.png;source=钓鱼等级提升后解锁,ingredients=比目鱼|午夜鲤鱼|鱿鱼墨汁,energy=恢复体力并提供钓鱼增益,获取方式=提升钓鱼等级并准备指定鱼类和鱿鱼墨汁后制作。材料跨度较大，通常不是第一年初期就能稳定量产的料理,主要用途=用于挑战高难度鱼、传奇鱼和补齐鱼类图鉴。钓鱼增益能提高容错率，适合在确认目标鱼出现条件后再使用,新手建议=不要把稀有鱼类材料随手卖掉。准备海泡布丁前先用鱼类查询器确认目标鱼季节、天气、时间和地点，避免浪费料理持续时间,关联规划=适合和鱼类查询器、鱼缸收集路线、钓鱼专题攻略一起查看，作为后期冲刺稀有鱼的准备项,links=/tools/fish|/guides/community-center-fish-tank-route|/guides/fishing-topic-guide|/wiki/fish
`),
  ...rows("quests", `
公告板求助;适合早期补金币和村民好感的镇上短期委托;28px-Quests_Icon.png;type=日常委托,trigger=镇中心公告板刷新,reward=金币|好感,获取方式=在皮埃尔杂货店附近公告板查看当天委托，按要求提交物品或完成目标。任务内容会随季节和当前解锁内容变化,主要用途=提供金币、好感和早期行动目标，也能引导玩家认识作物、鱼类、怪物掉落和采集物的用途,新手建议=不要为了低额奖励交出第一份季节限定样本。接任务前确认物品是否还要用于社区中心、图鉴、料理或后续路线,关联规划=适合和季节物品保留清单、图鉴详情、社区中心清单一起查看，决定哪些委托值得接,links=/guides/seasonal-items-to-keep|/tools/community-center|/wiki/items|/wiki/quests
特别订单板;把种植、钓鱼和下矿拆成周目标的大型委托系统;28px-Quests_Icon.png;type=特别订单,trigger=镇长家附近订单板开放,reward=金币|配方|特殊奖励,获取方式=解锁特别订单板后，每周从候选订单中选择一个完成。订单通常需要较长周期、较多物品或特定行动路线,主要用途=获取特殊配方、设备、金币和后续玩法入口。它比普通公告板更适合做阶段目标，也能推动矿洞、钓鱼、种植和送礼路线联动,新手建议=接单前先看库存、季节和剩余时间，不要只看奖励。材料不足或季节不合适时，宁可等下一轮订单,关联规划=适合和任务板攻略、矿洞掉落、鱼类查询器、作物收益工具一起使用，把订单拆成每日目标,links=/guides/quest-board-special-orders-route|/guides/mines-drops-and-floor-resource-route|/tools/fish|/tools/crops
头骨钥匙;把普通矿洞推进到沙漠矿洞收益线的关键解锁物;28px-Quests_Icon.png;type=主线解锁,trigger=矿洞深层探索,reward=头骨山洞入口,获取方式=推进普通矿洞深层探索后获得头骨钥匙，之后可用于进入沙漠的头骨山洞。它代表矿洞路线从基础材料转入高风险高收益阶段,主要用途=解锁头骨山洞、铱矿和更高强度的矿洞收益路线，也会推动炸弹、食物、运气料理和背包管理的重要性,新手建议=拿到钥匙不代表马上适合刷沙漠矿洞。先准备资金、食物、炸弹和回程节奏，普通矿洞材料路线仍然不能断,关联规划=适合和矿洞 1-120 层路线、矿洞掉落资料、背包体力路线一起查看，再决定什么时候进入沙漠矿洞,links=/guides/mines-floor-120-resource-monster-route|/guides/mines-drops-and-floor-resource-route|/guides/beginner-backpack-and-energy-route|/wiki/locations
黑暗护符;连接下水道、巫师和女巫沼泽的后期主线物品;28px-Quests_Icon.png;type=主线任务,trigger=社区中心或 Joja 项目后续,reward=进入女巫沼泽路线,获取方式=完成社区中心或 Joja 项目后，按巫师后续任务推进，在指定地点取得黑暗护符并继续解锁女巫沼泽相关内容,主要用途=推进后期主线区域、解锁新地点和后续功能。它不是普通可售物品，而是连接下水道、巫师、女巫沼泽和后期探索的任务节点,新手建议=接到任务后按路线推进即可，不要把它当成资源收益目标。若前置地点还没熟悉，先查看地点地图和主线任务说明,关联规划=适合和地点地图、任务指南、社区中心路线一起查看，确认前置完成后再处理后续主线,links=/wiki/locations|/wiki/quests|/guides/community-center-topic-guide|/tools/community-center
`),
  ...rows("locations", `
皮埃尔杂货店;决定季节种植、背包升级和公告板任务节奏的核心商店;36px-Pierre_Icon.png;area=鹈鹕镇中心,open=白天营业,features=种子|背包|日历,获取方式=开局即可前往鹈鹕镇中心访问。这里是多数季节种子、背包升级和公告板路线的核心地点,主要用途=购买作物种子、升级背包、查看日历和处理公告板任务。它决定第一年春夏秋三季的种植节奏和启动资金分配,新手建议=每季第一天先来这里确认种子和日历，不要把钱一次性花空。背包升级通常会明显改善钓鱼、下矿和采集效率,关联规划=适合和作物收益计算器、第一年路线、季节保留清单一起使用，决定买什么种子和何时升级背包,links=/tools/crops|/guides/year-one-spring-money-route|/guides/seasonal-items-to-keep|/wiki/crops
铁匠铺;把矿洞资源转化为工具效率和晶球收益的关键地点;36px-Blacksmith_Icon.png;area=鹈鹕镇东侧,open=白天营业,features=工具升级|晶球|矿石加工,获取方式=开局后可前往镇东侧铁匠铺访问。带上矿石、金钱和需要升级的工具即可安排升级或处理晶球,主要用途=升级工具、砸开晶球、处理矿洞资源。它直接影响浇水效率、清理农场、进入秘密森林和后续矿石路线,新手建议=升级工具前确认天气和农田需求，避免关键浇水日没有喷壶。晶球可以攒一批再处理，节省跑图时间,关联规划=适合和洒水器解锁、矿洞掉落、第一年路线一起查看，把矿石收入转化为工具效率,links=/guides/sprinkler-unlock-and-ore-route|/guides/mines-drops-and-floor-resource-route|/guides/year-one-spring-money-route|/wiki/items
玛妮牧场;从种地过渡到动物产品和稳定日常产出的牧场地点;36px-Marnie_Icon.png;area=煤矿森林南部,open=白天营业,features=动物|干草|牧场用品,获取方式=从农场南侧前往煤矿森林即可到达。建好鸡舍或畜棚后，可在这里购买动物并补充部分牧场相关用品,主要用途=开启动物产品路线，购买鸡、牛等动物，并衔接鸡舍、畜棚、干草和动物产品收集。它是从种地转向稳定日常产出的关键地点,新手建议=不要只买动物不准备饲料和建筑空间。动物路线需要每日照顾和库存管理，先确认资金、干草和社区中心目标,关联规划=适合和动物产品路线、社区中心清单、村民送礼规划一起查看，决定先开鸡舍还是畜棚,links=/guides/coop-barn-animal-products-route|/tools/community-center|/guides/villager-gift-birthday-recommendation|/wiki/items
博物馆;判断矿物文物是捐赠、保留还是出售的收集地点;36px-Prehistoric_Skull.png;area=鹈鹕镇东南侧,open=白天开放,features=捐赠|奖励|图鉴收集,获取方式=开局后可前往鹈鹕镇东南侧博物馆。获得矿物、文物或晶球开出的新物品后，可选择捐赠补全收藏,主要用途=完成收藏、领取奖励、推进图鉴目标，也能帮助玩家判断哪些矿物和文物是首次获得还是重复品,新手建议=第一份新矿物或文物通常优先捐赠，重复品再考虑出售或保留。不要把所有晶球产物都卖掉，先确认博物馆是否缺样本,关联规划=适合和矿洞掉落、物品百科、姜岛核桃路线一起查看，把矿洞收获分成捐赠、保留和出售三类,links=/guides/mines-drops-and-floor-resource-route|/wiki/items|/guides/ginger-island-golden-walnut-route|/wiki/locations
`)
];

const detailGuidance = [
  ["crops", "茄子", {
    "获取方式": "秋季从皮埃尔杂货店购买种子后种植，成熟后可重复收获。它适合秋季前半段下种，作为低维护的持续产出作物。",
    "主要用途": "用于秋季作物补样本、料理和任务储备，也能在主力作物之外提供稳定小额现金流。它不是秋季最高收益核心，但很适合填补社区中心和图鉴缺口。",
    "新手建议": "第一年秋季至少保留一份普通品质，不要全部卖掉。农田空间有限时少量种植即可，把主力地块留给蔓越莓、南瓜和社区中心需要的作物。",
    "关联规划": "适合和秋季赚钱路线、社区中心清单、作物收益计算器一起使用，确认茄子在当前地块和剩余天数里是否值得扩种。",
    links: ["/tools/crop-profit", "/guides/year-one-fall-money-route", "/tools/community-center", "/wiki/crops"]
  }],
  ["crops", "山药", {
    "获取方式": "秋季从皮埃尔杂货店购买种子后种植，成熟后单次收获。播种前要确认秋季剩余天数，避免月底来不及成熟。",
    "主要用途": "用于秋季作物收集、料理和任务储备，也可作为秋季中段的稳定出货作物。它的价值在于补齐用途，而不是取代蔓越莓或南瓜。",
    "新手建议": "建议第一年保留一份普通品质用于清单和图鉴，资金紧张时其余可以出售。不要因为它单次收获就忽略社区中心样本。",
    "关联规划": "适合放进春夏秋必留物品清单，和南瓜、茄子、蔓越莓一起规划秋季作物样本与现金流。",
    links: ["/tools/community-center", "/guides/seasonal-items-to-keep", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "苋菜", {
    "获取方式": "秋季从皮埃尔杂货店购买种子后种植，属于中等周期作物。适合秋季前中期安排，月底补种前要核对成熟时间。",
    "主要用途": "可用于任务、出货和秋季图鉴补全，也能作为不依赖加工的现金补充。它不是必铺作物，但常在任务和收集路线中用到。",
    "新手建议": "第一年秋季可以少量种植并留样本，避免临时接到需求时又要等下一年。地块紧张时优先保证社区中心核心作物。",
    "关联规划": "适合与秋季路线、任务指南和作物收益计算器一起查看，判断苋菜是补样本还是扩大出货。",
    links: ["/guides/year-one-fall-money-route", "/wiki/quests", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "朝鲜蓟", {
    "获取方式": "通常在中后期秋季稳定购买种子后种植，成熟后单次收获。它更适合已有稳定资金和农田节奏的存档。",
    "主要用途": "用于料理、图鉴和秋季高价值出货补充，也可作为第二年秋季的作物组合之一。它的意义更多在于补齐资料和厨房需求。",
    "新手建议": "第一年不用强求朝鲜蓟。等商店稳定供应后，先种少量留样本，再根据料理和收益需求决定是否扩大。",
    "关联规划": "适合和温室作物、秋季收益路线、图鉴详情使用指南一起看，避免把它当成第一年必须追的目标。",
    links: ["/guides/greenhouse-crops-processing-route", "/guides/year-one-fall-money-route", "/guides/wiki-item-detail-reading-guide", "/wiki/crops"]
  }],
  ["crops", "甜菜", {
    "获取方式": "解锁沙漠后可从绿洲购买种子，在秋季种植。它需要先处理巴士或沙漠访问条件，不属于开局即可稳定获得的作物。",
    "主要用途": "用于料理、任务和沙漠作物补充，也可以作为秋季中后期的额外出货。它的价值取决于你是否已经能稳定前往绿洲。",
    "新手建议": "没有沙漠前不用为了甜菜卡进度。解锁绿洲后先少量种植并保留样本，再根据任务和料理需求处理多余产物。",
    "关联规划": "适合和沙漠解锁、季节保留清单、秋季作物收益一起规划，避免因为交通条件没准备好而漏掉播种窗口。",
    links: ["/wiki/locations/desert", "/guides/seasonal-items-to-keep", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "菠萝", {
    "获取方式": "推进姜岛内容后获得种子并种植，成熟后可持续产出。它更偏中后期岛屿农场和温室规划，不是第一年主线刚需。",
    "主要用途": "适合岛屿农场、温室和长期作物区，也可进入加工与礼物储备路线。它的优势是后期稳定产出，而不是前期开局现金。",
    "新手建议": "刚解锁姜岛时先保留种子和第一批产物，不要全部出售。等岛屿农场和洒水器稳定后，再考虑扩大种植规模。",
    "关联规划": "适合与姜岛核桃路线、温室加工路线和作物收益计算器一起使用，判断菠萝适合放在哪个长期生产区。",
    links: ["/guides/ginger-island-golden-walnut-route", "/guides/greenhouse-crops-processing-route", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "芋头", {
    "获取方式": "芋头属于姜岛相关作物，推进岛屿内容后获得并种植。它适合在岛屿农场逐步扩种，前期不用强行追。",
    "主要用途": "用于岛屿作物图鉴、料理和后期库存，也能补充姜岛阶段的稳定产出。它的价值更多体现在解锁岛屿后的持续规划。",
    "新手建议": "第一次拿到芋头时建议先留样本和种植材料，不要只看售价处理。岛屿农场稳定后再按空间和洒水器扩张。",
    "关联规划": "适合和姜岛路线、温室果树规划、作物收益计算器一起看，把岛屿农场分成长期作物和短期补种两类。",
    links: ["/guides/ginger-island-golden-walnut-route", "/guides/greenhouse-fruit-tree-planning", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "齐瓜", {
    "获取方式": "齐瓜主要出现在齐先生限时任务中，不应按普通农作物长期规划。任务期间需要围绕种子获取、扩种和截止时间安排。",
    "主要用途": "核心用途是完成齐先生相关挑战，平时不作为常规现金作物。它的价值来自任务进度，而不是日常出货。",
    "新手建议": "接到任务前先确认时间、体力和农田规模。不要把齐瓜和普通作物混在同一套收益判断里，任务结束后优先处理任务目标。",
    "关联规划": "适合和齐先生任务、后期物品保留清单、作物收益判断一起查看，明确什么时候该集中扩种，什么时候不需要保留。",
    links: ["/wiki/quests", "/guides/seasonal-items-to-keep", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "霜瓜", {
    "获取方式": "霜瓜是 1.6 新增冬季作物之一，通常通过冬季相关种子来源获得并种植。它让冬季也能安排农田生产。",
    "主要用途": "用于冬季作物图鉴、出货和季节补种规划，也适合帮助冬季不只依赖钓鱼和下矿。它的主要价值是填补冬季农田空窗。",
    "新手建议": "第一次获得霜瓜建议先留样本，再根据冬季剩余天数决定是否扩大。不要把全部冬季体力都锁在浇水上。",
    "关联规划": "适合和冬季准备、作物收益计算器、图鉴详情使用指南一起看，判断冬季农田、矿洞和钓鱼的时间分配。",
    links: ["/guides/winter-prep-year-two-route", "/tools/crop-profit", "/guides/wiki-item-detail-reading-guide", "/wiki/crops"]
  }],
  ["crops", "胡萝卜", {
    "获取方式": "胡萝卜是 1.6 新增春季作物，通常通过春季相关种子来源获得并种植。成熟周期较短，适合春季补空地。",
    "主要用途": "用于春季图鉴、早期食物和小额现金补充，也能帮助新手在第一周之后填补农田空窗。",
    "新手建议": "拿到胡萝卜种子后可以先种少量，保留第一批样本。它适合补节奏，不建议替代防风草、土豆、草莓等核心规划。",
    "关联规划": "适合与第一年春季路线、作物收益计算器和季节保留清单一起看，决定春季空地是补现金还是补样本。",
    links: ["/guides/year-one-spring-money-route", "/tools/crop-profit", "/guides/seasonal-items-to-keep", "/wiki/crops"]
  }],
  ["crops", "西兰花", {
    "获取方式": "西兰花是 1.6 新增秋季作物，通常通过秋季相关种子来源获得并种植。适合秋季中前段安排，月底补种前要看剩余天数。",
    "主要用途": "用于秋季图鉴、出货和库存补充，也能在南瓜、蔓越莓之外提供新的秋季作物选择。",
    "新手建议": "第一批西兰花建议留样本。秋季资金紧张时不要盲目扩种，先确认社区中心、畜牧建筑和冬季准备资金是否够用。",
    "关联规划": "适合和秋季赚钱路线、季节保留清单、作物收益计算器一起用，判断新作物是否比传统秋季作物更适合当前存档。",
    links: ["/guides/year-one-fall-money-route", "/guides/seasonal-items-to-keep", "/tools/crop-profit", "/wiki/crops"]
  }],
  ["crops", "夏南瓜", {
    "获取方式": "夏南瓜是 1.6 新增夏季作物，通常通过夏季相关种子来源获得并种植。它适合夏季农田有空位时补种。",
    "主要用途": "用于夏季图鉴、出货和新版本作物收集，也可以作为蓝莓、甜瓜、啤酒花之外的补充选择。",
    "新手建议": "第一次获得夏南瓜时先保留样本，不要全部卖掉。第一年夏季仍要优先保证主力现金流和洒水器材料。",
    "关联规划": "适合和夏季赚钱路线、作物收益计算器、图鉴详情使用指南一起看，把新增作物放进原有夏季规划里比较。",
    links: ["/guides/year-one-summer-money-route", "/tools/crop-profit", "/guides/wiki-item-detail-reading-guide", "/wiki/crops"]
  }],

  ["fish", "蓝铁饼鱼", {
    "获取方式": "蓝铁饼鱼主要在姜岛河流环境中钓到，适合解锁岛屿后集中补图鉴。出发前先确认岛屿交通、背包空间和当天其他目标。",
    "主要用途": "用于鱼类图鉴、鱼塘规划和岛屿阶段的钓鱼收集。它不是早期社区中心核心鱼，但对后期补全图鉴很重要。",
    "新手建议": "没有解锁姜岛前不用惦记这条鱼。登岛后可把它和金色核桃、岛屿农场、火山地牢路线合并安排。",
    "关联规划": "适合和鱼类查询器、姜岛核桃路线、图鉴详情使用指南一起查看，确认地点和当天路线是否顺路。",
    links: ["/tools/fish", "/guides/ginger-island-golden-walnut-route", "/guides/wiki-item-detail-reading-guide", "/wiki/fish"]
  }],
  ["fish", "传说之鱼", {
    "获取方式": "传说之鱼属于春季雨天山区湖泊的高难目标，通常需要较高钓鱼等级、合适渔具和充分准备后再挑战。",
    "主要用途": "主要用于传说鱼收集和图鉴完成，不是社区中心必交鱼。捕获后更适合作为收藏，不建议随手出售。",
    "新手建议": "第一年春季不必硬钓。先提升钓鱼等级、准备食物和鱼钩，再挑雨天专门挑战，失败也不要影响主线节奏。",
    "关联规划": "适合和鱼类查询器、钓鱼入门攻略、季节物品保留清单一起使用，区分普通鱼和收藏级目标。",
    links: ["/tools/fish", "/guides/beginner-fishing-guide-and-fish-search", "/guides/seasonal-items-to-keep", "/wiki/fish"]
  }],
  ["fish", "绯红鱼", {
    "获取方式": "绯红鱼属于夏季海滩特殊地点的高难鱼，通常需要较高钓鱼能力和明确地点。挑战前先用鱼类查询器确认条件。",
    "主要用途": "用于传说鱼收藏和图鉴补全，不承担普通社区中心鱼缸路线。它的价值在于稀有度和完成度。",
    "新手建议": "夏季新手优先处理社区中心鱼缸、稳定收入和工具升级。绯红鱼可以等钓鱼等级和装备更稳后再补。",
    "关联规划": "适合和鱼缸路线、钓鱼入门攻略、季节鱼筛选一起查看，把高难收藏鱼从日常赚钱鱼中分开处理。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/guides/beginner-fishing-guide-and-fish-search", "/wiki/fish"]
  }],
  ["fish", "鮟鱇鱼", {
    "获取方式": "鮟鱇鱼是秋季北部木桥区域的特殊鱼，通常需要明确地点和一定钓鱼准备。它更适合秋季专门安排一天补收集。",
    "主要用途": "主要用于传说鱼收藏和图鉴完成。它不属于普通鱼缸必交路线，但对后期完整图鉴很有价值。",
    "新手建议": "第一年秋季如果农场、矿洞和社区中心压力很大，可以先跳过。等钓鱼等级和装备稳定后再回头补。",
    "关联规划": "适合和秋季路线、鱼类查询器、图鉴详情使用指南一起看，安排一个不影响作物收获的钓鱼日。",
    links: ["/tools/fish", "/guides/year-one-fall-money-route", "/guides/wiki-item-detail-reading-guide", "/wiki/fish"]
  }],
  ["fish", "冰川鱼", {
    "获取方式": "冰川鱼是冬季特定水域的高难鱼，适合冬季钓鱼等级较高后挑战。准备食物、渔具和充足时间比临时碰运气更重要。",
    "主要用途": "用于传说鱼收藏和图鉴完成。冬季没有大量作物压力时，可以把它作为钓鱼挑战目标之一。",
    "新手建议": "冬季新手可以先处理矿洞、工具升级和社区中心缺口，再挑战冰川鱼。不要把所有冬季时间都耗在反复失败上。",
    "关联规划": "适合和冬季准备路线、鱼类查询器、钓鱼入门攻略一起看，判断什么时候挑战最不影响整体进度。",
    links: ["/guides/winter-prep-year-two-route", "/tools/fish", "/guides/beginner-fishing-guide-and-fish-search", "/wiki/fish"]
  }],
  ["fish", "变种鲤鱼", {
    "获取方式": "变种鲤鱼需要解锁下水道后在对应区域钓到。它和博物馆捐赠、钥匙解锁、下水道路线相关，前期无法直接获取。",
    "主要用途": "用于特殊鱼收集和图鉴补全，也能让玩家熟悉下水道与科罗布斯相关内容。它不是早期社区中心必交目标。",
    "新手建议": "前期遇到矿物和文物优先考虑捐赠，尽早推进下水道解锁。解锁后再专门安排钓鱼，不要在未开放前浪费时间查找。",
    "关联规划": "适合和下水道地点、鱼类查询器、季节物品保留清单一起看，把博物馆进度和特殊鱼收集合并规划。",
    links: ["/wiki/locations/krobus-icon", "/tools/fish", "/guides/seasonal-items-to-keep", "/wiki/fish"]
  }],
  ["fish", "虾虎鱼", {
    "获取方式": "虾虎鱼是 1.6 新增鱼类，主要与煤矿森林瀑布区域相关。钓之前先用鱼类查询器确认地点，避免在普通河流反复空钓。",
    "主要用途": "用于新版本鱼类图鉴补全和收集路线，也适合在整理煤矿森林日程时顺手处理。",
    "新手建议": "如果当前目标是社区中心鱼缸，先确认虾虎鱼是否属于你的当日缺口。新版本鱼类可以分批补，不必影响主线节奏。",
    "关联规划": "适合和鱼类查询器、社区中心鱼缸路线、图鉴详情使用指南一起查看，区分必交鱼和补图鉴鱼。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/guides/wiki-item-detail-reading-guide", "/wiki/fish"]
  }],

  ["cooking", "生鱼片", {
    "获取方式": "与莱纳斯提升关系后获得配方，拥有厨房后可用任意鱼制作。它是把普通鱼转化为稳定食物的常用料理。",
    "主要用途": "用于补体力、处理低价值鱼、下矿和跑图前备餐。普通鱼较多时，生鱼片能减少背包里零散鱼类的管理成本。",
    "新手建议": "不要把社区中心或难钓限定鱼拿去做生鱼片。优先使用常见鱼，稀有鱼先看图鉴详情和鱼缸需求。",
    "关联规划": "适合和鱼类查询器、季节保留清单、背包体力路线一起使用，决定哪些鱼能做食物，哪些鱼要先保留。",
    links: ["/tools/fish", "/guides/seasonal-items-to-keep", "/guides/beginner-backpack-and-energy-route", "/wiki/cooking"]
  }],
  ["cooking", "幸运午餐", {
    "获取方式": "获得配方并准备对应材料后在厨房制作。它属于需要提前备料的增益料理，不适合临出门才临时凑。",
    "主要用途": "主要用于需要运气的日程，比如下矿、开晶球、刷稀有掉落或冲关键楼层。它能提升目标日的整体收益稳定性。",
    "新手建议": "前期材料不充足时不用强求。等你开始专门刷矿洞、晶球或稀有资源，再把幸运午餐作为重要日程的准备项。",
    "关联规划": "适合和矿洞掉落路线、矿洞前40层路线、背包体力管理一起规划，决定哪天值得使用增益料理。",
    links: ["/guides/mines-drops-and-floor-resource-route", "/guides/mines-floor-40-preparation-route", "/guides/beginner-backpack-and-energy-route", "/wiki/cooking"]
  }],
  ["cooking", "矿工特供", {
    "获取方式": "解锁配方并准备对应材料后在厨房制作，通常服务于下矿和资源收集日程。它不是日常随便消耗的普通食物。",
    "主要用途": "用于矿洞探索、补体力和提升下矿容错，适合冲电梯、刷矿石和处理怪物较多的楼层。",
    "新手建议": "下矿前准备一两份可靠食物比空手硬冲更重要。材料紧张时优先给需要推进楼层或刷矿石的日期使用。",
    "关联规划": "适合和矿洞前40层、矿洞掉落、洒水器矿石路线一起规划，把料理当成提高下矿效率的消耗品。",
    links: ["/guides/mines-floor-40-preparation-route", "/guides/mines-drops-and-floor-resource-route", "/guides/sprinkler-unlock-and-ore-route", "/wiki/cooking"]
  }],
  ["cooking", "蟹黄糕", {
    "获取方式": "获得配方并准备蟹笼或海鲜相关材料后在厨房制作。它通常和海滩、蟹笼、钓鱼路线相关。",
    "主要用途": "适合跑图、下矿和需要持续行动的日程，也能作为较高质量的体力补给。对于移动效率和防御需求都有帮助。",
    "新手建议": "前期如果蟹笼材料少，不要为了料理消耗掉社区中心或任务需要的海鲜样本。先确认鱼缸和清单缺口。",
    "关联规划": "适合和鱼类查询器、社区中心鱼缸路线、背包体力路线一起看，决定海鲜材料是留清单还是做料理。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/guides/beginner-backpack-and-energy-route", "/wiki/cooking"]
  }],
  ["cooking", "香辣鳗鱼", {
    "获取方式": "解锁配方并准备鳗鱼等材料后在厨房制作，也可能通过其他后期渠道获得。适合在重要探索日前提前准备。",
    "主要用途": "常用于骷髅洞穴、矿洞刷资源和高强度探索日。移动速度与运气类收益让它非常适合冲层和找稀有资源。",
    "新手建议": "鳗鱼本身有天气和时间条件，第一条不要急着做料理。先确认鱼缸、图鉴和任务需求，再处理多余材料。",
    "关联规划": "适合和鱼类查询器、矿洞掉落路线、季节物品保留清单一起规划，避免把难补的鳗鱼提前消耗掉。",
    links: ["/tools/fish", "/guides/mines-drops-and-floor-resource-route", "/guides/seasonal-items-to-keep", "/wiki/cooking"]
  }],
  ["cooking", "南瓜汤", {
    "获取方式": "获得配方后，用南瓜等材料在厨房制作。它通常依赖秋季作物储备，适合秋冬之后的探索日程。",
    "主要用途": "可作为下矿、骷髅洞穴和高压力战斗日的增益料理，也能消耗多余南瓜库存。它把秋季作物和矿洞路线连接起来。",
    "新手建议": "第一年秋季先保留南瓜样本和社区中心需求，再考虑料理。不要把唯一南瓜做掉导致献祭或任务卡住。",
    "关联规划": "适合和秋季赚钱路线、矿洞前40层、季节保留清单一起看，决定南瓜是出售、保留还是做成料理。",
    links: ["/guides/year-one-fall-money-route", "/guides/mines-floor-40-preparation-route", "/guides/seasonal-items-to-keep", "/wiki/cooking"]
  }],
  ["cooking", "海之菜肴", {
    "获取方式": "获得配方并准备对应鱼类材料后在厨房制作。它适合在钓鱼等级和鱼类目标明确后使用。",
    "主要用途": "主要用于提升钓鱼表现，帮助处理难钓鱼、社区中心鱼缸和季节限定鱼。它是钓鱼日的功能性料理。",
    "新手建议": "先用鱼类查询器确认目标鱼条件，再决定是否使用料理。不要把稀有或必交鱼随手做成材料。",
    "关联规划": "适合和社区中心鱼缸路线、钓鱼入门攻略、鱼类查询器一起用，安排雨天鱼、夜间鱼和高难鱼的补钓计划。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/guides/beginner-fishing-guide-and-fish-search", "/wiki/cooking"]
  }],
  ["cooking", "龙虾浓汤", {
    "获取方式": "获得配方后，用龙虾等材料在厨房制作，通常需要蟹笼或稳定海鲜来源配合。",
    "主要用途": "适合钓鱼日、补高难鱼和长时间海边路线，也可作为较强的体力补给。它常服务于鱼类收集而非普通出货。",
    "新手建议": "前期龙虾来源不稳定时不要急着消耗。先完成鱼缸和图鉴关键缺口，再用多余材料制作料理。",
    "关联规划": "适合和鱼类查询器、鱼缸路线、海滩地点资料一起查看，把蟹笼产物和钓鱼目标合并安排。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/wiki/locations/beach", "/wiki/cooking"]
  }],
  ["cooking", "三倍浓缩咖啡", {
    "获取方式": "解锁配方后用咖啡制作，也可通过部分商店或活动渠道获得。它是日常效率最高的常用饮品之一。",
    "主要用途": "用于跑图、送礼、下矿、钓鱼和大规模农活，帮助减少移动时间。它的价值来自节省时间，而不是直接出货。",
    "新手建议": "拿到咖啡豆后建议逐步建立咖啡储备，不要只按豆子售价判断。关键日程前准备饮品会明显提高效率。",
    "关联规划": "适合和咖啡豆、背包体力路线、矿洞掉落路线一起看，把速度饮品纳入每日路线规划。",
    links: ["/wiki/crops/coffee-bean", "/guides/beginner-backpack-and-energy-route", "/guides/mines-drops-and-floor-resource-route", "/wiki/cooking"]
  }],
  ["cooking", "姜汁汽水", {
    "获取方式": "推进姜岛和相关内容后获得配方或材料，在厨房制作。它更偏中后期探索和高价值日程。",
    "主要用途": "适合火山地牢、骷髅洞穴、晶球和稀有资源日程，帮助提升关键行动日的收益稳定性。",
    "新手建议": "没有稳定姜岛材料前不用强求。等你开始频繁刷火山、骷髅洞穴或稀有掉落时再准备。",
    "关联规划": "适合和姜岛核桃路线、矿洞掉落、火山地牢资料一起查看，决定哪类后期日程值得消耗。",
    links: ["/guides/ginger-island-golden-walnut-route", "/guides/mines-drops-and-floor-resource-route", "/wiki/locations/volcano-dungeon", "/wiki/cooking"]
  }],
  ["cooking", "粉红蛋糕", {
    "获取方式": "获得配方后准备甜点材料在厨房制作，也可通过部分事件或渠道获得。它偏向礼物和高质量补给。",
    "主要用途": "可作为较高体力回复食物，也常用于村民送礼路线。它更适合特殊日程或礼物准备，不是普通日常消耗品。",
    "新手建议": "材料不足时不要为了补体力随便做粉红蛋糕。先确认是否有生日、礼物或任务需求，再处理库存。",
    "关联规划": "适合和村民礼物攻略、温室果树规划、季节保留清单一起查看，把甜点材料和送礼日程合并安排。",
    links: ["/guides/villager-gift-birthday-recommendation", "/guides/greenhouse-fruit-tree-planning", "/guides/seasonal-items-to-keep", "/wiki/cooking"]
  }],
  ["cooking", "水果沙拉", {
    "获取方式": "获得配方后用水果类材料在厨房制作。它通常依赖果树、温室或稳定水果库存，适合中期以后制作。",
    "主要用途": "用于高质量体力补给、料理收集和水果库存消耗。果树稳定后，多余水果可以转化为料理或礼物资源。",
    "新手建议": "第一批水果优先确认社区中心、礼物和图鉴需求，不要全部做成料理。温室果树成型后再批量处理更稳。",
    "关联规划": "适合和温室果树规划、村民礼物路线、图鉴详情使用指南一起看，决定水果是卖、送礼还是做料理。",
    links: ["/guides/greenhouse-fruit-tree-planning", "/guides/villager-gift-birthday-recommendation", "/guides/wiki-item-detail-reading-guide", "/wiki/cooking"]
  }],

  ["skills", "耕种", {
    "获取方式": "通过种植、收获作物和照顾动物逐步提升。农田规模、动物建筑和每日浇水效率都会影响耕种成长速度。",
    "主要用途": "解锁洒水器、加工设备、职业路线和更稳定的农场收益，是作物收益、动物产品和后期工匠路线的基础。",
    "新手建议": "不要只靠扩大农田冲等级。第一年应把作物规模控制在能浇完的范围内，同时尽早准备洒水器和加工设备。",
    "关联规划": "适合和作物收益计算器、第一年春夏秋赚钱路线、温室加工路线一起看，决定扩田和加工的节奏。",
    links: ["/tools/crop-profit", "/guides/year-one-spring-money-route", "/guides/greenhouse-crops-processing-route", "/wiki/skills"]
  }],
  ["skills", "采矿", {
    "获取方式": "通过敲碎矿石、石头和推进矿洞逐步提升。电梯节点、背包空间和食物准备会直接影响采矿效率。",
    "主要用途": "解锁矿石、熔炉、洒水器材料、工具升级和大量机器制作资源，是农场自动化和矿洞收益的关键技能。",
    "新手建议": "前期以每 5 层电梯为目标，不要盲目清空整层。铜矿、铁矿、煤炭优先服务洒水器和工具升级。",
    "关联规划": "适合和矿洞前40层、矿洞掉落、洒水器解锁路线一起使用，把采矿日和农田扩张节奏绑定。",
    links: ["/guides/mines-floor-40-preparation-route", "/guides/mines-drops-and-floor-resource-route", "/guides/sprinkler-unlock-and-ore-route", "/wiki/skills"]
  }],
  ["skills", "采集", {
    "获取方式": "通过采集野外物品、砍树、收集硬木和处理季节采集物提升。它和体力、路线规划、季节物品保留关系很强。",
    "主要用途": "提供木材、硬木、季节采集物、野外种子和部分社区中心材料，是建筑、工具和长期资源库存的重要来源。",
    "新手建议": "不要把所有采集物都直接卖掉。每个季节至少留一批样本，木材和硬木更应优先服务建筑、工具和姜岛前置。",
    "关联规划": "适合和季节必留物品清单、秘密森林、社区中心进度一起看，把采集路线纳入每日跑图。",
    links: ["/guides/seasonal-items-to-keep", "/wiki/locations/hardwood", "/tools/community-center", "/wiki/skills"]
  }],
  ["skills", "钓鱼", {
    "获取方式": "通过钓鱼、收蟹笼和完成钓鱼相关目标提升。季节、天气、时间和地点会决定当天适合追哪些鱼。",
    "主要用途": "用于社区中心鱼缸、前期现金流、料理材料、鱼塘和完整图鉴。它也是新手第一年很稳定的收入来源。",
    "新手建议": "先练常见鱼和低难度地点，再挑战雨天鱼、夜间鱼和传说鱼。每次出门前用鱼类查询器确认目标条件。",
    "关联规划": "适合和鱼类查询器、鱼缸路线、钓鱼入门攻略一起使用，按季节和天气安排每日目标。",
    links: ["/tools/fish", "/guides/community-center-fish-tank-route", "/guides/beginner-fishing-guide-and-fish-search", "/wiki/skills"]
  }],
  ["skills", "战斗", {
    "获取方式": "通过在矿洞、骷髅洞穴、火山地牢等区域击败怪物提升。武器、防具、食物和返程时间会影响战斗风险。",
    "主要用途": "提升矿洞生存能力，获取怪物掉落、冒险家公会目标和后期装备材料。它和采矿收益、戒指、武器强化紧密相关。",
    "新手建议": "前期不要低血量硬打。武器伤害不足时优先撤退或升级装备，把食物、楼梯和返程时间当作战斗准备的一部分。",
    "关联规划": "适合和矿洞前40层、矿洞掉落、火山地牢资料一起看，决定什么时候刷怪物掉落，什么时候优先推进楼层。",
    links: ["/guides/mines-floor-40-preparation-route", "/guides/mines-drops-and-floor-resource-route", "/wiki/locations/volcano-dungeon", "/wiki/skills"]
  }],
  ["skills", "精通系统", {
    "获取方式": "五项基础技能满级后开放精通洞窟，后续经验会转化为精通进度。它属于后期效率系统，不是第一年硬性目标。",
    "主要用途": "用于解锁五类精通奖励，强化农场、矿洞、钓鱼、采集和战斗效率。不同精通适合解决不同阶段的瓶颈。",
    "新手建议": "前期不用为了精通牺牲主线节奏。等五项技能自然满级后，再根据当前最缺的是收益、材料、移动效率还是战斗能力来选择。",
    "关联规划": "适合和精通系统攻略、火山地牢、矿洞掉落和作物收益路线一起看，规划后期效率优先级。",
    links: ["/guides/mastery-system-guide-1-6", "/wiki/locations/mastery-cave", "/guides/mines-drops-and-floor-resource-route", "/wiki/skills"]
  }]
];

for (const [dataset, name, guidance] of detailGuidance) {
  const entry = entries.find((item) => item.dataset === dataset && item.name === name);
  if (entry) {
    entry.attributes = { ...entry.attributes, ...guidance };
  }
}
...
const baseArticles = [
  {
    title: "第一年春季完整发展路线",
    slug: "year-one-spring-complete-route",
...
按“浇水与收获、限时任务、雨天鱼类、矿井电梯、普通采集”的顺序安排。电视天气预报决定工具升级时机，幸运频道决定是否深挖矿井。只要春末拥有稳定现金、基础矿石和草莓收入，夏季就能顺利进入自动化阶段。`,
  ...
  {
    title: "温室解锁与全年种植布局",
    slug: "greenhouse-unlock-year-round-layout",
...
每周固定一天收获、补种和装填小桶，箱子中常备种子、肥料与传送图腾。发现小桶长期空置时应减少出售原果，发现水果大量积压时则扩建加工棚。定期检查果树间距和洒水器覆盖，不要让临时摆放的箱子占据作物格。`,
  ...
  {
    title: "全鱼类季节与天气速查",
    slug: "all-fish-season-weather-reference",
...
如果只差一两条鱼，检查是否混淆河流、森林池塘和山区湖泊，也要确认跨越午夜后的时间。魔法鱼饵可以忽略季节、时间和天气限制，是后期查漏的有效工具，但仍必须在正确地点抛竿。`,
  ...
  {
    title: "村民送礼与生日指南",
    slug: "villager-gifts-and-birthdays-guide",
...
全部精通后，可把目标转向完美度、齐先生任务、全图鉴和农场美化。效率工具的意义不只是赚钱，更是释放每天的时间。`,
  ...
  {
    title: "姜岛解锁与金色核桃收集路线",
    slug: "ginger-island-golden-walnut-route",
...
`,
  ...
  {
    title: "温室果树收益与边缘规划",
    slug: "greenhouse-fruit-tree-planning",
    summary: "把温室中间地块、边缘果树和姜岛后期水果分开规划，避免把果树误当作普通作物收益计算。",
    body: `温室解锁后，很多新手会把所有注意力放在中间地块，忽略边缘空间和果树的长期价值。果树不是短期爆发型收入，也不适合直接和蓝莓、蔓越莓、杨桃、上古水果用同一套逻辑比较。它更像稳定补给：提供水果样本、礼物材料、料理材料和长期库存，同时不抢温室中间的核心种植面积。

这篇攻略适合已经开始使用[作物收益计算器](/tools/crops)，准备把温室从“临时种地”升级成“长期生产区”的玩家。普通新手不需要第一天就买满树苗，先保证洒水器、背包、矿洞和社区中心节奏，再把果树作为中期投资加入规划。

## 先区分普通作物和果树收益

作物收益计算器更适合比较普通作物：种子成本、生长天数、重复收获、剩余季节天数、是否加工。果树的重点不同，它需要提前种下并等待成熟，收益不是从播种当天开始结算，也不能像普通作物那样按季节末尾灵活补种。因此看果树时，不要只问“每天赚多少”，更应该问“它是否占用关键地块、是否能补足收集和送礼需求、是否能长期稳定产出”。

温室中间地块优先留给高价值或可持续作物，例如你在[温室作物与加工路线](/guides/greenhouse-crops-processing-route)里规划的上古水果、杨桃或其他长期作物。果树适合放在边缘，因为边缘空间本来不能像中间那样高效铺满作物。这样做的核心收益不是单棵树立刻回本，而是把闲置边缘变成稳定水果来源。

如果你还在第一年春夏，先不要因为看到温室果树收益就提前透支资金。更稳的节奏是先跑通[第一年春季赚钱路线](/guides/year-one-spring-money-route)和夏季基础建设，再逐步购买树苗。果树一旦位置规划错，后面调整成本和等待时间都更高。

## 温室边缘怎么安排

温室规划可以分成两层：中间地块负责核心现金流，边缘负责果树、通行和长期补给。果树成长期间周围需要保持干净，不能被杂物、设备、地板或其他阻挡物影响。因此在种下树苗前，先确认边缘位置不会被洒水器、箱子、路径或装饰占掉。

苹果、石榴、橙子、桃子、樱桃和杏子这类普通果树，放进温室后最大的好处是减少季节等待。你不必等到对应季节才补样本，也能更稳定地准备礼物和料理材料。对应图鉴可以从[苹果](/wiki/items/apple)、[石榴](/wiki/items/pomegranate)、[橙子](/wiki/items/orange)、[桃子](/wiki/items/peach)这些条目开始看，先确认获取方式、主要用途和新手建议。

边缘果树不要挤满到影响操作。普通玩家更需要顺手的通行路线和清晰的箱子管理，而不是把每一格都压到极限。建议先用少量果树覆盖社区中心和送礼需求，再决定是否扩充到完整果园。如果你经常忘记留样本，可以把第一批水果直接放进专门的“社区中心/礼物”箱子。

## 第一批水果怎么处理

第一批果树水果不建议全部卖掉。苹果、石榴等水果常和社区中心、送礼、料理或后续图鉴补全相关，盲目出售会让你在需要时重新等季节或等果树产出。使用[社区中心进度清单](/tools/community-center)时，可以把果树水果和季节限定物品一起检查，先确定哪些必须保留。

送礼路线也要提前考虑。水果不一定是所有村民的最佳礼物，但它们常作为稳定、低风险的礼物库存使用。若你正在推进人物关系，可以结合[村民礼物与生日推荐](/guides/villager-gift-birthday-recommendation)筛选优先目标，不要把所有高品质水果直接出售。

如果水果数量开始溢出，再考虑出售或加工。普通新手的顺序可以是：第一批留样本，第二批补社区中心和礼物，稳定产出后再处理多余库存。这样虽然短期金币少一点，但能减少后期返工。对于想快速赚钱的阶段，中间地块的作物和加工链通常比果树更关键。

## 姜岛水果与后期扩展

姜岛解锁后，香蕉和芒果会进入后期果树规划。它们不属于第一年普通新手必须追求的内容，更适合在岛屿推进稳定后作为长期补给和图鉴补全目标。本站已有[香蕉](/wiki/items/banana)条目，可以先用来理解姜岛水果的定位；芒果则可以先放在后期清单中，等素材和条目完善后再纳入独立详情。

后期规划不要只看“更多树等于更多收益”。你还要考虑采收路线、箱子分类、送礼库存、社区中心完成度以及岛屿任务节奏。如果你正在推进[姜岛解锁与金色核桃收集路线](/guides/ginger-island-golden-walnut-route)，建议把姜岛果树和火山、核桃、岛屿农场一起安排，不要单独为水果打乱整体路线。

最终，温室果树的价值在于长期稳定和减少季节限制。中间地块负责主要收益，边缘果树负责补给和收集，姜岛水果负责后期扩展。把三者分开看，温室就不会变成“哪里空就种哪里”的临时仓库，而会变成一个可持续运转的农场核心区。`,
    coverImage: "/assets/game/36px-Pomegranate.png",
    featured: 0,
    categories: ["农场经营", "进阶攻略"],
    chapterChecks: [
      "先用作物收益计算器比较普通作物，不把果树和季节作物直接混算。|温室中间地块优先留给核心现金流作物。|果树作为长期补给和收集来源看待。",
      "种树前确认边缘位置和周围空位。|先覆盖苹果、石榴、橙子、桃子等常用水果需求。|不要让果树阻挡通行、箱子和日常操作路线。",
      "第一批水果先留样本，再决定送礼、社区中心或出售。|用社区中心清单确认是否缺果树水果。|推进人物关系时再结合礼物推荐决定保留数量。",
      "姜岛阶段再加入香蕉和芒果等后期水果。|不要为了果树打乱岛屿推进、火山和核桃路线。|把中间作物、边缘果树和姜岛水果分成三套规划。"
    ]
  },
  {
    title: "第一周完整发展路线",
    slug: "year-one-first-week-complete-route",
    summary: "把春 1 到春 7 的清地、种植、钓鱼、矿洞、背包和社区中心节奏排清楚，适合完全新手照着执行。",
    body: `# 第一周完整发展路线

第一周决定的是整年节奏，不是单日极限收益。普通新手最稳的目标，是把第一批作物种下、建立钓鱼现金流、开出矿洞电梯、保留社区中心样本，并在复活节前准备好草莓资金。本文适合还没形成操作习惯的玩家，建议和[第一年春季赚钱路线](/guides/year-one-spring-money-route)、[作物收益计算器](/tools/crops)、[社区中心进度清单](/tools/community-center)一起使用。

不要把第一周理解成固定作业。天气、钓鱼手感、下矿运气和背包空间都会改变日程。下面给的是普通新手稳定路线：少走弯路，不追求速通，优先保证工具、体力、现金和样本不出问题。

## 春 1：清地、播种和箱子

第一天先清理屋前一小块地，种下系统给的防风草。不要把农场全部清空，体力会被杂草和石头耗光，后面反而没有力气砍树、浇水和采集。建议先整理出一块能每天稳定浇完的区域，再砍几棵树做箱子，把作物样本、鱼类、矿洞材料和杂物分开放。

第一天的重点是建立“少量稳定”而不是扩大面积。防风草成熟后至少保留几份普通品质样本，用于社区中心和任务判断。晚上回家后先把陌生物品放进箱子，不确定用途时查[作物与种子图鉴](/wiki/crops)或[物品百科](/wiki/items)，不要因为缺钱把第一份样本卖掉。

## 春 2 到 4：钓鱼启动资金

钓竿解锁后，钓鱼是第一周最直接的现金来源。钓鱼不需要种子投入，也能顺便练等级、准备社区中心鱼缸。新手可以把上午留给浇水和采集，下午到河边、海滩或山湖练钓鱼。遇到下雨天，优先打开[鱼类查询器](/tools/fish)看看当前能不能钓到雨天限定鱼。

这几天不要把所有钱都压在补种上。春季作物能赚钱，但手浇压力、成熟时间和复活节草莓资金更重要。如果钓鱼手感差，可以少量补防风草或土豆；如果钓鱼稳定，就把现金留一部分给背包和草莓。卖鱼前先确认鱼缸需要，不熟悉的鱼至少留一条。

## 春 5 到 7：矿洞开放后的材料路线

矿洞开放后，不要急着清空整层。第一周下矿的目标是开电梯、拿铜矿、煤炭、石头和晶球，顺便练战斗。每 5 层一次电梯进度很关键，能让后续补材料更稳定。带一点食物，看到楼梯就先考虑下层，不要为了每块石头耗到深夜。

铜矿和煤炭直接关系熔炉、工具升级和后续洒水器规划。若你准备走更清晰的矿洞路线，可以接着看[矿洞前 40 层准备与收益路线](/guides/mines-floor-40-preparation-route)。第一周不需要追求深层，只要把基础材料和电梯节奏跑起来，第二周就会轻松很多。

## 第一周复盘：背包、草莓和社区中心

春 7 前后检查三件事：背包是否快不够用，复活节是否有草莓资金，社区中心样本是否开始保留。背包升级能显著减少钓鱼、采集和下矿时的来回次数，但如果资金紧张，也可以先把草莓预算放在前面。关键是别同时扩田、买背包、下矿和补种，资金会被拆得太散。

每周末打开社区中心清单，把春季作物、春季采集和早期鱼类缺口标出来。第一周只要建立“浇水、赚钱、保留样本、开矿洞”的循环，后面春季赚钱路线就能自然接上。新手最容易输在误卖和乱扩张，而不是少赚了一天鱼钱。
`,
    coverImage: "/assets/game/36px-Wood.png",
    featured: 1,
    categories: ["新手入门", "第一年路线"],
    chapterChecks: [
      "春 1 只清出能稳定浇完的小地块。|先做箱子，把样本、鱼类和矿洞材料分开。|第一份陌生物品先保留，不急着卖。",
      "春 2 到 4 用钓鱼建立现金流。|雨天用鱼类查询器确认限定鱼。|补种前先留草莓和背包预算。",
      "矿洞开放后优先开电梯和收集铜矿、煤炭、石头。|带食物下矿，看到楼梯不要恋战。|第一周不追求深层，先跑通材料节奏。",
      "春 7 前复盘背包、草莓资金和社区中心样本。|不要同时扩田、买背包、下矿和大量补种。|把春季缺口标进社区中心清单。"
    ]
  },
  {
    title: "全村民生日与礼物推荐",
    slug: "all-villager-birthdays-and-gifts",
    summary: "用生日优先级、低风险礼物池和每日路线规划村民关系，减少送错礼物和错过生日的损失。",
    body: `# 全村民生日与礼物推荐

村民关系不是每天随机送礼，而是围绕生日、住址、日程和礼物库存做长期规划。生日当天送对礼物的收益很高，平时则更适合用低风险礼物维持节奏。本文不要求你背下每个村民所有喜好，而是教你建立一套可执行的送礼流程，并配合[村民关系图鉴](/wiki/villagers)和[村民礼物推荐与生日送礼路线](/guides/villager-gift-birthday-recommendation)查漏补缺。

新手最常见的问题，是把社区中心、任务或稀有材料随手送掉。送礼前先确认物品用途，再决定是否作为礼物。若你还在第一年春夏，礼物路线要服从农场、矿洞和背包节奏，不要为了跑遍全镇耽误关键作物和雨天鱼。

## 生日优先级最高

生日是送礼路线的核心。普通日子送错礼物损失有限，生日送错则很浪费机会。每个季节开始时，先看本季生日，提前准备礼物箱。礼物箱不需要一开始就豪华，常见作物、花、料理、矿物和部分动物产品都可以作为候选，但必须先查对应村民详情。

建议把生日分成三类：已经有合适礼物的村民、需要提前准备的村民、暂时放弃的村民。第一年不用追求所有人满心，优先选择路线顺、礼物好准备、后续任务或生活便利相关的目标。生日当天如果不确定礼物，宁愿查图鉴也不要凭感觉送。

## 建立低风险礼物池

低风险礼物池的作用是减少试错。普通品质作物、花、常见料理、矿物和部分水果可以作为日常礼物来源，但不同村民差异很大，不能一概而论。你可以在[物品百科](/wiki/items)里查看物品用途，确认它不是社区中心关键材料或稀有加工原料后，再放进礼物箱。

第一年更推荐“少量稳定”而不是“全村覆盖”。比如每天路过皮埃尔商店、诊所、酒吧或海滩时顺路送几位村民，不要为一个村民跑半张地图。礼物路线要和采集、钓鱼、下矿、买种子结合起来，顺路才可持续。

## 按住址和日程规划路线

送礼效率取决于路线。村民分布在小镇、海滩、山区、牧场、农场周边和特殊区域，日程还会随季节、天气和事件变化。新手不需要记所有日程，但可以建立几个常用点：上午办农场事，中午路过商店和诊所，傍晚去酒吧，雨天减少远距离送礼。

如果你正在推进[第一年新手路线总览](/guides/beginner-year-one-route-overview)，送礼最好安排在固定节点：买种子时送镇中心，钓鱼时送海滩，去矿洞时顺路看山区。这样礼物不会抢走生产时间，关系也能稳步提升。

## 礼物和资源不要互相冲突

很多高价值物品既能送礼，也能用于社区中心、料理、加工或任务。不要把第一份稀有鱼、稀有矿物、季节限定作物随手送掉。先用[社区中心进度清单](/tools/community-center)确认是否需要献祭，再判断能不能作为礼物。礼物不是越贵越好，合适和稳定更重要。

后期有稳定动物产品、果树水果和料理后，礼物路线会轻松很多。前期则建议把生日当作重点，平日送礼保持顺路。只要不误送关键材料、不漏掉重点生日，村民关系就不会拖累主线发展。
`,
    coverImage: "/assets/game/36px-Abigail_Icon.png",
    featured: 0,
    categories: ["村民关系", "送礼路线"],
    chapterChecks: [
      "每季第一天查看本季生日，提前准备礼物箱。|生日礼物不确定时先查村民详情。|第一年优先送路线顺、礼物好准备的村民。",
      "建立低风险礼物池，但先确认物品不是关键材料。|不要为了全村覆盖牺牲农场和矿洞节奏。|礼物路线必须顺路可持续。",
      "按镇中心、海滩、山区、牧场等路线送礼。|买种子、钓鱼和下矿时顺路处理村民。|雨天减少远距离送礼，把时间给限定目标。",
      "第一份稀有物品先查社区中心和图鉴用途。|高价值物品不等于最佳礼物。|后期再用果树水果、动物产品和料理扩展礼物池。"
    ]
  },
  {
    title: "矿洞 1-120 层资源与怪物掉落路线",
    slug: "mines-floor-120-resource-monster-route",
    summary: "按 1-40、40-80、80-120 三段规划矿石、晶球、怪物材料和电梯进度，适合从前期过渡到完整矿洞。",
    body: `# 矿洞 1-120 层资源与怪物掉落路线

矿洞不是一次性清到 120 层的挑战，而是长期材料来源。铜矿、铁矿、金矿、煤炭、晶球、怪物掉落和武器过渡都和楼层段有关。新手如果只追求下层数，常常会缺煤、缺食物、缺背包空间，最后工具升级和洒水器都卡住。本文把矿洞拆成三段，帮助你决定每次下矿的目标。

如果你还没有稳定到 40 层，建议先看[矿洞前 40 层准备与收益路线](/guides/mines-floor-40-preparation-route)；如果目标是洒水器和矿石链，可以接着看[洒水器解锁与矿石路线](/guides/sprinkler-unlock-and-ore-route)。本篇重点是完整 1-120 层节奏。

## 1 到 40 层：铜矿、石头和基础怪物

前 40 层压力较低，但它决定熔炉、基础工具升级和第一批洒水器材料。目标不是清空每层，而是尽快开电梯，同时收集铜矿、石头、煤炭和常见怪物掉落。看到楼梯时优先下层，除非当前层矿点很密集。每 5 层电梯进度都比多敲几块石头更重要。

这阶段背包空间很容易爆。出门前清空背包，只带武器、镐子、食物和少量必要工具。晶球、矿石、怪物掉落和洞穴萝卜都可以留，普通杂物视空间处理。回家后把矿洞材料单独放箱子，后续查[物品百科](/wiki/items)时会更容易判断用途。

## 40 到 80 层：铁矿、煤炭和装备过渡

40 层后怪物压力上升，铁矿开始成为核心目标。铁矿关系到工具升级、洒水器和后续制作，煤炭也会持续紧缺。不要把所有时间用在打怪，除非你明确需要怪物材料。电梯推进仍然重要，但如果遇到矿点密集层，可以短暂停留补铁矿。

这阶段建议带更稳定的食物，并关注武器伤害是否够用。如果怪物打得太慢，优先处理冒险家公会奖励或购买过渡武器，不要硬扛到深夜。下矿收益不是只看今天挖了多少矿，而是看是否能支持下一轮工具、洒水器和农场扩张。

## 80 到 120 层：金矿、精华和后期材料

80 层以后，金矿、火石英、虚空精华、太阳精华等材料逐渐重要。怪物更密集，时间和血量管理比前期更关键。不要带着低体力和满背包硬冲，尤其是晚上返回时间要提前规划。目标可以分成两类：冲电梯到 120 层，或者回到已解锁层数刷指定材料。

如果正在准备中后期设备，金矿和精华要分开存放，不要随手卖。晶球也建议集中处理，方便后续补矿物、博物馆和稀有材料。矿洞越往后越需要明确目标，否则一天时间会消耗在低收益战斗上。

## 怪物掉落和晶球怎么处理

怪物掉落不要全当垃圾。蝙蝠翅膀、史莱姆、精华、骨头碎片等材料会出现在制作、任务或后续路线中。第一份或前几组建议保留，等确认用途后再出售多余部分。晶球也不要当天随便清掉，背包紧张时可以集中带去铁匠铺处理，减少往返。

每次下矿前写清楚目标：开电梯、刷铜矿、刷铁矿、刷金矿、刷煤炭、刷怪物材料或找晶球。目标不同，应该去的楼层也不同。把矿洞当作材料仓库，而不是每天随机冒险，收益会稳定很多。
`,
    coverImage: "/assets/game/36px-Staircase.png",
    featured: 0,
    categories: ["矿洞", "资源路线"],
    chapterChecks: [
      "1 到 40 层优先开电梯和收集铜矿、石头、煤炭。|背包只带必要工具和食物。|矿洞材料单独放箱子，方便后续制作。",
      "40 到 80 层重点补铁矿和煤炭。|武器伤害不足时先换过渡武器。|矿点密集层可以停留，但不要牺牲电梯进度。",
      "80 到 120 层明确是冲层还是刷材料。|金矿、火石英和精华分开保存。|提前规划返程，避免深夜损失。",
      "怪物掉落先保留样本，再处理重复品。|晶球集中处理，减少往返。|每次下矿前写清楚本次目标。"
    ]
  },
  {
    title: "社区中心四季物品保留清单",
    slug: "community-center-seasonal-items-checklist",
    summary: "按春夏秋冬整理社区中心常见保留物品，避免卖掉季节限定作物、鱼类、采集物和矿洞材料。",
    body: `# 社区中心四季物品保留清单

社区中心推进最怕“当季卖掉，来年再补”。很多物品看起来普通，却被季节、天气、地点或成长时间锁住。本文按春、夏、秋、冬整理保留思路，帮助新手在出售前做一次检查。具体缺口仍建议以[社区中心进度清单](/tools/community-center)为准，再配合[作物与种子图鉴](/wiki/crops)和[鱼类图鉴](/wiki/fish)确认获取条件。

这不是完整献祭表，而是“卖东西前的安全清单”。你不需要囤满所有物品，但每类至少留一份样本，能明显减少返工。

## 春季：基础作物、采集和雨天鱼

春季要保留防风草、土豆、花椰菜、青豆等基础作物样本，尤其是社区中心和任务可能用到的物品。春季采集物也不要全部卖掉，第一份先放进箱子。复活节后的草莓主要用于赚钱，但第一批收入也要为背包、工具和夏季种子留预算。

鱼类方面，春季雨天目标很重要。遇到雨天先打开[鱼类查询器](/tools/fish)，确认当前地点和时间能否补到社区中心相关鱼。新手常见误区是晴天钓了一堆普通鱼，却错过雨天窗口。春季结束前至少复盘一次鱼缸缺口。

## 夏季：高收益作物和天气窗口

夏季常见赚钱作物很多，但不要把蓝莓、甜瓜、辣椒、玉米等全部当现金流处理。第一份样本先保留，再决定出售或加工。夏季也是背包、洒水器和矿洞节奏上升的时期，如果扩田过猛，很容易没有时间钓鱼和下矿。

夏季鱼类同样受天气、时间和地点影响。雨天鱼、夜间鱼和海边鱼要提前查，不要等季末补缺口。若你正在执行[社区中心鱼缸收集路线](/guides/community-center-fish-tank-route)，夏季每天出门前都应该判断今天是否有鱼缸目标。

## 秋季：南瓜、玉米和长期库存

秋季作物收益高，但社区中心需求也集中。南瓜、玉米、茄子、山药、蔓越莓等物品最好先留样本。秋季采集物同样不要全卖，榛子、蘑菇、野梅等都可能与收集、料理或任务相关。这个季节是温室前置和第二年准备的关键，不要只看当天出货箱金币。

秋季也是补鱼、补矿洞、补动物产品的阶段。若春夏漏了项目，秋季要更重视清单复盘。每周打开一次社区中心进度，区分“本季必须完成”和“可以冬季或第二年补”的项目，避免把时间浪费在低优先级目标上。

## 冬季：整理缺口和补资源

冬季没有普通露天作物压力，适合整理箱子、补矿洞材料、补鱼类缺口、推进动物和工匠品。冬季采集物也要先留样本，不要因为没有种地就把采集物全部卖掉。若温室已经接近解锁，可以开始规划长期作物和果树。

冬季的重点是复盘：哪些房间还缺季节物，哪些必须等明年，哪些可以通过旅行货车、矿洞、钓鱼或加工补上。把缺口写清楚，第二年春季就不会重复第一年的混乱。社区中心不是每天硬推，而是每季少漏一点，最终自然完成。

实际执行时，建议在家门口放一个“社区中心样本箱”，每次回家先把新作物、新鱼、新采集物和新矿物放进去，再处理出货。每周固定一天打开清单，按“本季还能拿到”“全年可补”“必须等明年”三类标记。这样即使你不背献祭表，也能把错误控制在很小范围。
`,
    coverImage: "/assets/game/36px-Summer.png",
    featured: 0,
    categories: ["社区中心", "四季规划"],
    chapterChecks: [
      "春季作物和采集物第一份先保留。|雨天先查鱼类查询器，确认鱼缸目标。|春末复盘鱼缸和春季作物缺口。",
      "夏季高收益作物先留样本再出售。|扩田不要挤掉钓鱼和下矿时间。|雨天鱼和夜间鱼提前查，不等季末补。",
      "秋季南瓜、玉米、采集物和蘑菇类先留。|每周区分必须完成和可推迟目标。|不要只看秋季出货箱金币。",
      "冬季整理箱子、矿洞材料、鱼类和工匠品缺口。|冬季采集物也先留样本。|把来年必须补的季节物写进清单。"
    ]
  },
  {
    title: "新手常见 20 个误区",
    slug: "beginner-common-mistakes",
    summary: "整理第一年最容易踩的 20 个坑，覆盖种地、钓鱼、矿洞、社区中心、送礼、背包和时间管理。",
    body: `# 新手常见 20 个误区

星露谷没有严格失败条件，但新手会因为误卖、乱扩田、错过季节窗口和没有规划而多花很多时间。本文把常见问题分成 20 个具体误区，重点不是吓你，而是让你知道哪些操作会拖慢第一年节奏。读完后可以结合[第一年新手路线总览](/guides/beginner-year-one-route-overview)和三个工具页建立自己的流程。

如果你不想一次看完，先记住一句话：第一份陌生物品先留，买种子前先算，雨天先查鱼，下矿先定目标。

## 种地和收益误区

误区 1：只看作物售价，不看成熟天数和种子成本。误区 2：季末还大量补种来不及成熟的作物。误区 3：扩田超过每天能浇完的范围。误区 4：把第一份季节作物全部卖掉。解决方法是播种前使用[作物收益计算器](/tools/crops)，再去[作物与种子图鉴](/wiki/crops)确认用途。

误区 5：把加工当成第一年唯一答案。木桶和罐头瓶确实重要，但前期设备、材料和时间都有限。先保证现金流、社区中心样本和工具升级，再逐步进入加工路线。误区 6：为了追高收益忽略体力，结果每天浇水到中午，其他系统都没时间推进。

## 钓鱼和社区中心误区

误区 7：雨天不查鱼，错过限定鱼。误区 8：夜间鱼窗口忘记补。误区 9：第一条陌生鱼直接卖掉。误区 10：只钓赚钱鱼，不看鱼缸需求。钓鱼前打开[鱼类查询器](/tools/fish)，按季节、天气、时间和地点筛一次，能避免大部分返工。

误区 11：社区中心只看一个收集包，忽略其他房间。误区 12：把季节限定物品当普通出货物卖掉。误区 13：不记录已完成和未完成项目，导致重复准备。每季开始和结束前打开[社区中心进度清单](/tools/community-center)，把当季能做的项目单独标出来。

## 矿洞和资源误区

误区 14：下矿没有目标，只是随机敲石头。误区 15：看到楼梯也不下，结果电梯进度慢。误区 16：煤炭、铜矿、铁矿和怪物掉落随手卖。矿洞前期应该围绕电梯、矿石、煤炭、晶球和怪物材料安排，具体可以参考[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)。

误区 17：不带食物或背包太满下矿。误区 18：晚上太晚才返程，损失金币和物品。下矿前清背包，带食物，确定今天是冲电梯、刷矿还是刷怪物材料。没有目标的下矿通常收益最低。

## 背包、送礼和时间误区

误区 19：背包升级太晚，钓鱼、采集和下矿都被迫频繁回家。背包不是装饰，它能直接节省时间。误区 20：为了送礼跑遍全镇，反而错过作物、鱼类和矿洞节奏。送礼要看生日和顺路路线，可以参考[全村民生日与礼物推荐](/guides/all-villager-birthdays-and-gifts)。

最终，新手不需要完美路线，只要减少低级返工。把工具用于关键决策：播种前算收益，雨天查鱼，卖东西前看清单，陌生物品点开图鉴详情。做到这些，第一年就会稳定很多。
`,
    coverImage: "/assets/game/36px-Time_Icon.png",
    featured: 0,
    categories: ["新手入门", "避坑指南"],
    chapterChecks: [
      "播种前先算成熟天数、种子成本和剩余季节。|扩田不能超过每天可浇水范围。|第一份季节作物先留样本。",
      "雨天和夜间先查鱼类查询器。|陌生鱼先保留，不直接卖。|社区中心每季开始和结束都复盘。",
      "下矿前确定目标：电梯、矿石、煤炭、晶球或怪物材料。|看到楼梯优先推进电梯。|矿洞材料先存箱子再处理。",
      "背包升级和送礼都要服从每日节奏。|生日优先，平日送礼顺路处理。|卖陌生物品前先看图鉴和社区中心清单。"
    ]
  },
  {
    title: "春季专题：开局资金、作物与社区中心",
    slug: "spring-season-topic-guide",
    summary: "春季专题入口，集中整理第一年春季的防风草、草莓、雨天鱼、矿洞开放和社区中心开局。",
    body: `# 春季专题：开局资金、作物与社区中心

春季是整年节奏的起点。这个季节的目标不是把所有系统都做到完美，而是建立现金流、保留关键样本、开启矿洞和社区中心，并为夏季扩张做准备。新手可以把春季理解为四条线：种地提供基础收入，钓鱼补现金，矿洞提供材料，社区中心决定哪些东西不能卖。

如果你只想按路线执行，可以先看[第一周完整发展路线](/guides/year-one-first-week-complete-route)和[第一年春季赚钱路线](/guides/year-one-spring-money-route)。如果你想自己规划，就从本专题开始，把春季拆成可检查的几个目标。

## 春季作物怎么选

防风草是最基础的起步作物，成熟快，适合建立浇水习惯和社区中心样本。土豆、花椰菜、青豆、草莓等作物各有用途，但不要只看售价。种子成本、成熟天数、是否重复收获、复活节购买窗口和剩余季节天数都会影响实际收益。播种前建议用[作物收益计算器](/tools/crops)核对。

草莓是春季重要节点，但不是唯一目标。普通新手可以攒一笔资金在复活节买草莓，同时保留背包和工具预算。不要为了草莓把所有日常节奏压垮；如果浇水压力太大，宁愿少种一点，也要保证钓鱼、采集和社区中心推进。

## 春季鱼类和雨天窗口

春季钓鱼既能赚钱，也能补社区中心鱼缸。雨天鱼和特定时间鱼容易被错过，所以每次下雨都应该打开[鱼类查询器](/tools/fish)确认目标。若你还不熟悉钓鱼，可以先看[新手钓鱼入门与鱼类查询使用指南](/guides/beginner-fishing-guide-and-fish-search)，再按当前地点练习。

卖鱼前先确认鱼缸需求。不熟悉的鱼至少留一条，等社区中心清单核对后再决定出售。春季不要只钓最值钱的鱼，能补清单的鱼往往更重要，因为错过后会拖到下一年或下一个雨天窗口。

## 矿洞开放后的春季节奏

矿洞开放后，春季时间会更紧。你需要在浇水、钓鱼、下矿之间切换。前期下矿重点是铜矿、煤炭、石头、晶球和电梯进度，不要试图每天清空整层。电梯每 5 层保存一次，越早开出节点，后续补矿越方便。

矿洞材料要为熔炉、工具升级和洒水器做准备。若你发现每天浇水占用太久，就需要开始规划洒水器和矿石路线。可以接着阅读[洒水器解锁与矿石路线](/guides/sprinkler-unlock-and-ore-route)。

## 春末复盘和夏季准备

春季结束前，检查三类缺口：社区中心春季物品是否保留，夏季种子和背包预算是否足够，矿洞材料是否支持下一阶段工具或洒水器。不要把春末最后几天全用来补种，来不及成熟的作物只会浪费本金。

夏季前最重要的是减少返工。箱子里应该有关键作物样本、鱼类样本、矿洞材料和一部分启动资金。春季不需要完美，但要为夏季留出选择空间。

如果春季时间被打乱，可以按“上午农场、下午补目标、晚上整理箱子”的简单模板执行。上午只处理浇水、收获和播种；下午根据天气决定钓鱼或下矿；晚上把陌生物品归入样本箱。这个节奏看起来普通，但能稳定避免卖掉样本、忘记雨天鱼和季末没钱买夏季种子的连锁问题。
`,
    coverImage: "/assets/game/36px-Daffodil.png",
    featured: 0,
    categories: ["专题", "春季"],
    chapterChecks: [
      "春季目标分成种地、钓鱼、矿洞和社区中心四条线。|先看第一周路线，再决定是否扩张。|不要追求第一季完美完成所有内容。",
      "播种前用作物收益计算器核对成熟天数和剩余季节。|草莓重要但不是唯一目标。|保留背包、工具和夏季预算。",
      "雨天优先查鱼类查询器。|陌生鱼先留样本。|鱼缸目标优先级高于普通赚钱鱼。",
      "春末复盘社区中心样本、夏季资金和矿洞材料。|不要补种来不及成熟的作物。|为夏季留出背包、洒水器和种子空间。"
    ]
  },
  {
    title: "夏季专题：蓝莓、鱼类与洒水器节奏",
    slug: "summer-season-topic-guide",
    summary: "夏季专题入口，整理蓝莓、啤酒花、甜瓜、雨天鱼、洒水器和矿洞材料的中期节奏。",
    body: `# 夏季专题：蓝莓、鱼类与洒水器节奏

夏季是第一年现金流明显变强的阶段，也是新手最容易扩张过头的阶段。蓝莓、甜瓜、啤酒花、辣椒、玉米等作物都能发挥作用，但它们对应的体力、加工、社区中心和长期规划不同。夏季的核心是扩大收入，同时减少手浇压力，把洒水器和矿洞材料接上。

如果你已经完成春季开局，可以先看[第一年夏季赚钱路线](/guides/year-one-summer-money-route)。本专题更像总入口，帮助你把作物、钓鱼、矿洞和社区中心放在同一张计划表里。

## 夏季作物不要只看蓝莓

蓝莓适合稳定现金流，甜瓜常用于社区中心和高价值样本，啤酒花更偏加工路线，辣椒和玉米则有各自用途。普通新手不必只种一种作物，建议把地块分成现金流、社区中心样本、加工预留和实验地块。使用[作物收益计算器](/tools/crops)时，把剩余天数和浇水能力一起考虑。

夏季扩田前先判断洒水器数量。如果每天手浇到中午，说明地块已经超过当前能力。与其继续买种子，不如安排矿洞日补铁矿、煤炭和工具材料。夏季赚钱的关键不是地越多越好，而是每天还能处理钓鱼、下矿和社区中心。

## 雨天鱼和夜间鱼窗口

夏季鱼类条件更复杂，雨天、夜间、地点和钓鱼等级都会影响目标。遇到雨天时，不要只想着省浇水，先打开[鱼类查询器](/tools/fish)确认鱼缸或高价值鱼目标。夜间鱼也要提前规划，白天农场和矿洞结束后，如果还有体力和时间，可以补一轮。

若你在推进社区中心，夏季不能只顾种地。鱼缸缺口往往比多卖几颗蓝莓更影响进度。可以参考[社区中心鱼缸收集路线](/guides/community-center-fish-tank-route)，把雨天鱼和季节限定鱼单独列出来。

## 洒水器和矿洞材料节奏

夏季是洒水器开始改变农场效率的时期。矿洞目标应该从“能下多少层”变成“我缺什么材料”。铁矿、煤炭、铜矿和晶球都要为工具、设备和洒水器服务。若你还没有形成下矿流程，可以接着看[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)。

每周至少安排一到两个明确矿洞日，避免天天被农场拖住。雨天适合工具升级或钓鱼，晴天如果浇水压力过大，就更要靠洒水器解放时间。夏季后半段应逐步减少纯手浇地块。

## 夏末为秋季做准备

夏末不要把所有现金花在最后一轮补种上。秋季种子、背包、工具和动物建筑都需要资金。社区中心方面，夏季作物和鱼类样本要先留，缺口用清单标出来。若已经开始加工路线，也要检查木桶或罐头瓶是否够用，避免作物堆仓。

夏季的成功标准不是单季最高收入，而是进入秋季时拥有更少手浇压力、更清楚的社区中心进度、更稳定的矿洞材料和更充足的启动资金。

执行上可以把一周拆成固定节奏：第一天检查种子和剩余天数，晴天优先维护农场和矿洞，雨天优先钓鱼或升级工具，周末复盘社区中心缺口。这样蓝莓、甜瓜、啤酒花不会互相抢资源，洒水器材料也能持续补进来，而不是等到秋季才发现自己还在全手浇。
`,
    coverImage: "/assets/game/36px-Melon.png",
    featured: 0,
    categories: ["专题", "夏季"],
    chapterChecks: [
      "夏季作物分成现金流、样本、加工和实验地块。|不要只看蓝莓，甜瓜和啤酒花也要按用途判断。|扩田前先看洒水器数量和手浇压力。",
      "雨天先查鱼类查询器，确认鱼缸和高价值鱼。|夜间鱼提前安排，不等季末补。|社区中心鱼缸缺口优先级高于普通出货。",
      "每周安排明确矿洞日。|下矿目标围绕铁矿、煤炭、工具和洒水器。|夏季后半段逐步减少纯手浇压力。",
      "夏末保留秋季启动资金。|夏季作物和鱼类样本先留。|检查加工设备是否能消化库存。"
    ]
  },
  {
    title: "秋季专题：南瓜、温室前置与第二年准备",
    slug: "fall-season-topic-guide",
    summary: "秋季专题入口，整理南瓜、蔓越莓、玉米、温室前置、社区中心补漏和第二年准备。",
    body: `# 秋季专题：南瓜、温室前置与第二年准备

秋季是第一年最容易赚到大笔现金的季节，但也是最容易因为收益高而忽略规划的季节。南瓜、蔓越莓、玉米、茄子、山药和采集物都可能关联社区中心、料理、任务或加工。秋季的目标不是把所有东西卖掉，而是把现金流、温室前置和第二年准备同时推进。

如果你需要完整路线，可以先看[第一年秋季赚钱路线](/guides/year-one-fall-money-route)。本专题负责把秋季重点拆成作物、温室、社区中心和冬季过渡四块。

## 秋季作物和样本保留

南瓜适合高价值目标和社区中心，蔓越莓适合稳定多次收获，玉米可以跨季延续，山药、茄子等也可能有用途。不要只按收益排行种满一种作物。每类至少留一份普通品质样本，再用[作物收益计算器](/tools/crops)判断剩余地块投入。

秋季作物如果进入加工路线，要考虑设备容量。罐头瓶和小桶不足时，高收益作物可能会堆在箱子里，实际现金回流变慢。普通新手可以先保证社区中心和现金流，再逐步扩大加工规模。

## 温室前置和茶水间补漏

秋季常常是温室解锁前的关键窗口。茶水间相关作物、动物产品、工匠品和品质作物都需要核对。打开[社区中心进度清单](/tools/community-center)，把还差的秋季物品和全年物品分开，不要等冬季才发现缺南瓜或其他季节物。

温室路线不只看作物，还关系洒水器、种子、加工设备和长期水果规划。如果已经接近解锁，可以提前阅读[温室作物与加工路线](/guides/greenhouse-crops-processing-route)和[温室果树收益与边缘规划](/guides/greenhouse-fruit-tree-planning)，避免温室开放后临时乱种。

## 鱼类、矿洞和动物产品补进度

秋季不要把全部时间交给农场。鱼类缺口、矿洞材料和动物产品都可能影响社区中心。雨天和夜间仍要查[鱼类查询器](/tools/fish)，矿洞则继续补金矿、煤炭、精华和晶球。若动物建筑已经启动，第一批动物产品要先核对用途再出售。

秋季现金充足后，很多玩家会同时升级工具、建建筑、买种子和扩加工设备。建议按顺序处理：先保证社区中心缺口，再处理能提高效率的工具和建筑，最后扩展长期收益。

## 秋末和冬季衔接

秋末复盘时，重点看冬季能不能补。冬季可以下矿、钓鱼、整理箱子、升级工具和处理动物产品，但不能补大多数露天秋季作物。季节锁定物品必须在秋末前确认。把缺口写进清单，避免第二年重复踩坑。

进入冬季前，箱子里最好有作物样本、矿洞材料、鱼类样本、动物产品和一笔第二年启动资金。秋季赚得多不等于可以随便花，第二年开局会需要更多投资空间。

秋季后半段尤其要避免把全部现金锁进慢回本项目。建筑、动物、加工设备和果树都很好，但它们会占用资金和材料。普通新手可以先满足社区中心与第二年春季启动资金，再把剩余资源投入长期项目。这个顺序能让冬季整理更轻松，也能让第二年春季不至于重新从零开始。
`,
    coverImage: "/assets/game/36px-Pumpkin.png",
    featured: 0,
    categories: ["专题", "秋季"],
    chapterChecks: [
      "秋季每类关键作物至少留一份样本。|不要只种单一高收益作物。|加工路线要看设备容量和现金回流。",
      "用社区中心清单核对茶水间和秋季限定物品。|温室接近解锁时提前规划长期作物。|果树和温室中间地块分开考虑。",
      "秋季仍要补鱼类、矿洞和动物产品。|现金充足后先补社区中心，再升级效率设备。|动物产品第一批先看用途再卖。",
      "秋末确认哪些缺口冬季无法补。|整理箱子和第二年资金。|不要把秋季收益全部花光。"
    ]
  },
  {
    title: "冬季专题：整理、矿洞与第二年规划",
    slug: "winter-season-topic-guide",
    summary: "冬季专题入口，整理无露天作物时的矿洞、钓鱼、工具升级、箱子复盘和第二年准备。",
    body: `# 冬季专题：整理、矿洞与第二年规划

冬季不是空档期，而是整理和补强期。没有普通露天作物压力后，你可以把时间投入矿洞、钓鱼、工具升级、社区中心补漏、箱子整理、动物产品和温室规划。很多第一年混乱的玩家，靠冬季复盘就能把第二年节奏拉回来。

如果你正在进入第一年冬季，建议先看[冬季准备与第二年路线](/guides/winter-prep-year-two-route)。本专题补充冬季每天该做什么，以及哪些事不要拖到第二年春季才想起来。

## 箱子和社区中心复盘

冬季第一件事是整理箱子。把作物样本、鱼类、矿洞材料、工匠品、动物产品和任务物品分开，再打开[社区中心进度清单](/tools/community-center)核对缺口。能冬季补的项目尽快安排，必须等来年季节的项目写清楚。

很多玩家箱子里其实已经有足够材料，只是没整理出来。冬季复盘能减少重复购买、重复钓鱼和重复下矿。陌生物品可以点进[物品百科](/wiki/items)看用途，不要随便丢掉看起来普通的材料。

## 矿洞和工具升级

冬季很适合集中下矿。没有大量浇水时间后，可以安排更多矿洞日，补铜矿、铁矿、金矿、煤炭、晶球和怪物材料。建议每次下矿前明确目标：刷矿、刷怪、开电梯、补晶球或找特定材料。可参考[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)。

工具升级也适合放在冬季集中处理。浇水壶、镐子、斧头等工具升级会影响第二年效率，但升级前要确认当天不需要使用。不要把所有资金都花光，第二年春季种子和建筑也需要预算。

## 钓鱼、动物和温室

冬季鱼类也有独立窗口。用[鱼类查询器](/tools/fish)按季节筛选冬季鱼，补鱼缸和图鉴缺口。动物产品和工匠品如果已经启动，也要整理第一批样本，确认社区中心和料理用途后再出售。

如果温室已经解锁或接近解锁，冬季是规划长期种植的好时机。中间地块、洒水器、作物种子、加工设备和果树边缘都可以提前设计。不要等温室开放后才临时把随机作物塞进去。

## 第二年春季准备

冬末要准备第二年春季启动资金、种子计划、工具等级和建筑目标。第二年通常会比第一年拥有更多系统：动物、加工、温室、矿洞深层、村民关系和岛屿前置。越早明确目标，春季越不会乱花钱。

冬季的价值是把混乱变成计划。整理箱子、补矿洞、查鱼、升级工具、复盘社区中心，这些看起来不如出货箱金币明显，却会决定第二年效率。

建议冬季按周安排：一到两天集中下矿，一天处理钓鱼和鱼缸缺口，一天升级或确认工具，一天整理动物产品、加工品和送礼库存。剩余时间再做自由探索。这样冬季不会变成漫无目的的跑图，也能把第二年需要的矿石、木材、煤炭、礼物和启动资金提前备好。

冬季最后三天再做一次“开春检查”：背包是否升级，种子预算是否留足，工具是否卡在升级中，社区中心是否有春季必须补的项目。确认这些以后，第二年春 1 就能直接播种和推进目标，而不是花一天重新找箱子、查缺口。
`,
    coverImage: "/assets/game/36px-Crystal_Fruit.png",
    featured: 0,
    categories: ["专题", "冬季"],
    chapterChecks: [
      "冬季先整理箱子并核对社区中心缺口。|能冬季补的尽快安排，来年季节物写清楚。|陌生材料先看物品百科用途。",
      "下矿前明确目标：矿石、晶球、怪物材料或电梯。|冬季集中补工具升级材料。|升级工具前确认近期不会用到。",
      "用鱼类查询器补冬季鱼和鱼缸缺口。|动物产品和工匠品第一批先看用途。|温室解锁前先规划作物和果树位置。",
      "冬末准备第二年春季资金、种子、工具和建筑目标。|不要把冬季当空档期。|把第一年的混乱整理成第二年计划。"
    ]
  },
  {
    title: "社区中心专题：房间优先级与四季补漏",
    slug: "community-center-topic-guide",
    summary: "社区中心专题入口，按房间、季节和补漏逻辑整理献祭路线，帮助新手减少误卖和返工。",
    body: `# 社区中心专题：房间优先级与四季补漏

社区中心看起来像一堆清单，实际是一套时间管理系统。每个房间依赖不同资源：工艺室偏采集，茶水间偏作物，鱼缸偏天气和时间，锅炉房偏矿洞，布告栏偏多系统收集，金库偏现金。新手不需要一次性记住所有物品，只要知道哪些会被季节锁住，哪些可以后补。

推荐先打开[社区中心进度清单](/tools/community-center)，再配合[社区中心前期优先完成路线](/guides/early-community-center-priority-route)和[社区中心四季物品保留清单](/guides/community-center-seasonal-items-checklist)执行。

## 房间优先级怎么排

前期优先处理季节明显的房间：工艺室、茶水间和鱼缸。采集物、作物和鱼类错过季节后补救成本较高。锅炉房可以随着矿洞推进自然完成，不一定要单独挤时间。金库更像现金目标，不必牺牲基础建设强行提前。

布告栏内容复杂，往往涉及动物产品、料理、工匠品和多种系统。新手可以先把它当作中期目标，遇到相关物品先留样本。不要因为想一次完成布告栏，就打乱农场基础建设。

## 四季补漏逻辑

每个季节开始时先看当前季节能获得什么。春季看春季作物、采集和雨天鱼；夏季看夏季作物和鱼类窗口；秋季看南瓜、玉米、采集物和温室前置；冬季看整理、矿洞、鱼类和动物产品。季节限定内容优先级高于全年可补内容。

补漏时不要只看缺什么，还要看今天能不能获得。缺鱼就查[鱼类查询器](/tools/fish)，缺作物就看[作物与种子图鉴](/wiki/crops)，缺矿物就安排矿洞日。清单给目标，图鉴和工具给获取路线。

## 物品保留和箱子管理

社区中心路线要求你建立样本箱。作物、鱼类、矿洞材料、工匠品、动物产品和采集物最好分开存放。第一份陌生物品先留，重复品再根据售价和用途出售。这个习惯比临时查攻略更可靠。

如果背包和箱子管理混乱，清单也会失效。每次回家后先把可能献祭的物品放入对应箱子，再出售确定无用的重复品。季末前统一核对一次，避免把最后一天浪费在找东西上。

## 完成节奏不要强求

社区中心不是越快越好。普通新手第一年完成部分房间已经很正常，没必要为了赶进度牺牲所有收入和探索。关键是不要漏掉季节限定物，不要卖掉关键样本，不要忘记雨天鱼和夜间鱼。

只要每季开始、雨天、季末这三个节点检查清单，社区中心就会逐步收敛。把它当作长期项目，而不是每天的压力来源。

检查时可以从“会消失的机会”开始：季节作物、雨天鱼、夜间鱼、当季采集物优先；矿洞材料、工匠品、金库这类可长期补的内容排后。这个排序能让你在时间不够时也做出正确取舍。社区中心真正难的不是材料多，而是你要知道今天错过的是一天，还是整整一年。

如果你只想用最简单的方法推进，可以每季做两张短清单：一张写“本季必拿”，一张写“顺手可补”。每天只看本季必拿，不被全量献祭表淹没；周末再处理顺手可补。这样既不会漏掉关键窗口，也不会让社区中心压过种地、钓鱼和矿洞。
`,
    coverImage: "/assets/game/36px-Bundle_Red.png",
    featured: 0,
    categories: ["专题", "社区中心"],
    chapterChecks: [
      "前期优先处理工艺室、茶水间和鱼缸。|锅炉房随矿洞推进，金库随现金流推进。|布告栏作为中期多系统目标。",
      "每季开始先看当季可获得物品。|缺鱼查鱼类查询器，缺作物查作物图鉴。|季节限定内容优先于全年可补内容。",
      "建立作物、鱼类、矿洞材料、工匠品、动物产品样本箱。|第一份陌生物品先留。|季末统一核对清单。",
      "不要为了社区中心牺牲所有收入和探索。|每季开始、雨天、季末固定检查。|把社区中心作为长期项目推进。"
    ]
  },
  {
    title: "钓鱼专题：季节窗口、鱼缸与夜间鱼",
    slug: "fishing-topic-guide",
    summary: "钓鱼专题入口，整理季节、天气、时间、地点、鱼缸和新手练级节奏，让鱼类查询更好用。",
    body: `# 钓鱼专题：季节窗口、鱼缸与夜间鱼

钓鱼难点不只是小游戏本身，而是鱼类条件复杂。季节、天气、时间、地点和钓鱼等级都会影响结果。新手如果只凭感觉换地点，很容易错过雨天鱼、夜间鱼和社区中心鱼缸目标。本专题教你用[鱼类查询器](/tools/fish)和[鱼类图鉴](/wiki/fish)建立钓鱼路线。

如果你还在入门阶段，可以先看[新手钓鱼入门与鱼类查询使用指南](/guides/beginner-fishing-guide-and-fish-search)；如果目标是社区中心，继续看[社区中心鱼缸收集路线](/guides/community-center-fish-tank-route)。

## 先按目标决定地点

钓鱼前先决定今天目标：赚钱、练级、补鱼缸、补图鉴或完成任务。赚钱时可以选路线近、鱼群稳定的地点；补鱼缸时必须按条件筛选；练级时不一定追高价值鱼，而是追稳定上钩和路线效率。目标不同，地点和时间都不同。

新手最容易犯的错误是“哪里顺眼去哪钓”。建议先打开查询器，选当前季节和天气，再看哪些地点有目标鱼。这样能少跑很多冤枉路。

## 雨天鱼和夜间鱼单独记录

雨天鱼和夜间鱼是最容易漏的类别。每个季节第一天，先查本季雨天目标和夜间目标。遇到雨天时，优先处理这些窗口，而不是照常种地或下矿。夜间鱼则需要提前留体力和背包空间，不能等到深夜才想起来。

社区中心鱼缸尤其依赖这些窗口。若你已经错过一次，不要焦虑，但要把下一次机会写进清单。鱼类查询器能快速告诉你当前时间是否还来得及。

## 鱼类用途和保留规则

第一条陌生鱼先留。鱼可能用于社区中心、料理、鱼塘、任务或后续路线。基础售价高不代表应该立刻卖，条件复杂的鱼补起来更麻烦。点进鱼类详情，看获取方式、用途、售价、新手建议和关联规划后再决定。

普通常见鱼可以卖掉补现金流；季节限定鱼、雨天鱼、夜间鱼和社区中心鱼至少保留一条。背包紧张时，优先保留条件复杂的鱼，普通鱼可以换成金币。

## 钓鱼和每日时间安排

钓鱼要和种地、下矿、送礼配合。晴天上午浇水，下午钓常规鱼；雨天省下浇水时间，优先钓限定鱼或升级工具；矿洞日不要临时再追远距离鱼。路线越简单越容易坚持。

每季末用查询器复盘未钓鱼类，把缺口分成“本季还能补”和“必须等下一季”。这样钓鱼就不会变成随机碰运气，而是可规划的收集路线。

如果某条鱼总是钓不到，不要只怀疑操作。先核对季节、天气、地点、时间和等级，再判断是否需要换钓竿、鱼饵或路线。鱼类详情页适合确认用途和是否值得保留，查询器适合决定今天去哪里。两者结合使用，才能把鱼缸、赚钱和图鉴补全放到同一条路线里。

普通新手可以给每个季节设一个小目标：晴天练稳定鱼，雨天追限定鱼，晚上补夜间鱼，季末查漏。钓鱼等级上来后，再考虑难度更高或路线更远的目标。这样不会因为一两条难鱼卡住心态，也能持续积累金币、料理材料和社区中心进度。

背包空间不足时，先保留条件复杂的鱼和社区中心鱼，常见鱼可以当日出售补现金。若当天已经钓到目标鱼，就不要在同一地点硬耗到深夜，早点回家整理箱子，第二天再换目标。
`,
    coverImage: "/assets/game/36px-Catfish.png",
    featured: 0,
    categories: ["专题", "钓鱼"],
    chapterChecks: [
      "钓鱼前先决定赚钱、练级、鱼缸、图鉴或任务目标。|用查询器筛季节和天气。|不要凭感觉随机换地点。",
      "每季第一天记录雨天鱼和夜间鱼。|雨天优先处理限定窗口。|夜间鱼提前留体力和背包空间。",
      "第一条陌生鱼先留。|条件复杂的鱼优先保留，常见鱼可出售。|点进鱼类详情确认用途。",
      "晴天钓常规鱼，雨天钓限定鱼。|矿洞日不要临时追远距离鱼。|季末复盘鱼类缺口。"
    ]
  },
  {
    title: "矿洞专题：电梯、矿石与怪物材料",
    slug: "mines-topic-guide",
    summary: "矿洞专题入口，整理电梯推进、矿石补给、晶球处理、怪物材料和下矿前准备。",
    body: `# 矿洞专题：电梯、矿石与怪物材料

矿洞是农场发展的材料核心。工具升级、洒水器、设备制作、任务和后期装备都离不开矿石、煤炭、晶球和怪物掉落。新手下矿如果没有目标，很容易一整天消耗很多体力，却没有拿到真正需要的材料。本专题帮助你把矿洞变成稳定补给路线。

完整楼层路线可以看[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)，前期玩家可以先看[矿洞前 40 层准备与收益路线](/guides/mines-floor-40-preparation-route)。

## 电梯比清层更重要

矿洞每 5 层保存一次电梯进度。前期最重要的目标通常不是清空当前层，而是找到楼梯并推进到下一个电梯节点。电梯越早打开，后续刷材料越省时间。遇到矿点密集层可以停留，但不要忘记当天核心目标。

下矿前清空背包，只带武器、镐子、食物和必要工具。背包越乱，越容易因为空间不足丢掉有用材料。

## 矿石和煤炭分阶段补

铜矿、铁矿、金矿和煤炭对应不同阶段。前期铜矿支撑熔炉和基础升级，中期铁矿支撑洒水器和工具，后期金矿和精华进入更多设备路线。煤炭几乎一直紧缺，不要轻易浪费。

如果你是为了洒水器下矿，就不要被随机怪物战斗拖住；如果是为了怪物材料，就选择更适合的楼层段。目标不同，收益判断也不同。

## 晶球和怪物掉落

晶球适合集中处理。零散带去铁匠铺会浪费时间，建议攒一批再开。怪物掉落也不要全部出售，史莱姆、蝙蝠翅膀、精华和骨头碎片等材料可能出现在制作、任务和后续路线里。第一批先留，重复品再处理。

物品用途不确定时，查看[物品百科](/wiki/items)详情。详情页会告诉你获取方式、用途、新手建议和关联规划，比单看名字可靠。

## 下矿日怎么安排

下矿日最好选择体力充足、背包空、当天没有大量农活的时候。雨天是好机会，因为不用浇水。带足食物，提前规划返程时间，避免深夜倒下。若武器伤害太低，先处理装备过渡，再继续冲层。

每次下矿结束后，把材料分类放箱子，并记录下次目标。矿洞收益来自长期积累，不是单日运气。

矿洞还要和农场计划联动。比如你想扩大夏季地块，就要提前准备洒水器材料；想升级工具，就要留出矿锭和铁匠铺时间；想推进社区中心，就要保留矿物样本和怪物材料。把矿洞看成“材料供应链”，而不是单纯刷钱地点，路线会清楚很多。

下矿复盘也很重要。回家后不要只把东西丢进同一个箱子，至少分成矿石、宝石晶球、怪物掉落、制作材料四类。下一次出门前看箱子缺什么，再决定去浅层、中层还是深层。这个习惯能减少重复刷同一段楼层，也能让工具升级和洒水器制作更稳定。

如果当天目标是冲电梯，就少恋战，看到楼梯先下；如果目标是刷材料，就选熟悉且怪物压力可控的楼层。炸弹、食物和返程时间都要提前准备。矿洞不是只考操作，更考你是否知道这一趟缺的是矿石、煤炭、晶球还是怪物掉落。

下矿前把目标写成一句话，例如“今天只开 5 层电梯”或“今天只补铁矿和煤炭”，执行会稳定很多。
`,
    coverImage: "/assets/game/36px-Gold_Ore.png",
    featured: 0,
    categories: ["专题", "矿洞"],
    chapterChecks: [
      "优先推进每 5 层电梯节点。|清背包再下矿。|矿点密集层可停留，但不能忘记目标。",
      "按阶段补铜矿、铁矿、金矿和煤炭。|洒水器日程和怪物材料日程分开。|煤炭长期保留。",
      "晶球集中处理。|第一批怪物掉落先留样本。|不确定用途时查看物品百科。",
      "雨天适合下矿。|带食物并提前返程。|回家后按材料类型分类存放。"
    ]
  },
  {
    title: "村民送礼专题：生日、礼物池与路线规划",
    slug: "villager-gift-topic-guide",
    summary: "村民送礼专题入口，整理生日优先级、低风险礼物池、住址路线和资源保留原则。",
    body: `# 村民送礼专题：生日、礼物池与路线规划

村民关系适合长期推进，不适合每天随机跑图。生日、礼物喜好、住址、日程和资源用途共同决定送礼效率。新手最需要掌握的是：生日优先，平时顺路，礼物先查用途，稀有材料不要乱送。本文作为村民送礼专题入口，连接[村民关系图鉴](/wiki/villagers)和[全村民生日与礼物推荐](/guides/all-villager-birthdays-and-gifts)。

如果你已经有明确目标村民，再点进对应村民详情查生日、住址和喜好。不要靠猜测送礼。

## 生日路线优先

生日当天送对礼物的价值高，所以每个季节第一天先看本季生日。准备礼物箱，把确定安全的礼物和候选礼物分开。当天路线要提前安排，不要晚上才想起村民可能已经回家或位置变化。

第一年不需要全村满心。优先处理路线顺、礼物容易准备、对你当前目标有帮助的村民。比如常路过的商店、海滩、山区和酒吧路线，都比远距离专门跑一趟更稳定。

## 礼物池要安全

礼物池不是越贵越好。很多高价值物品可能用于社区中心、料理、任务或制作。送礼前先查[物品百科](/wiki/items)或村民详情，确认不会影响关键路线。普通作物、花、料理、果树水果和部分矿物都可以成为礼物来源，但要按村民喜好判断。

若你正在推进社区中心，先用[社区中心进度清单](/tools/community-center)确认物品不需要献祭，再放入礼物箱。不要把第一份稀有鱼、稀有矿物或季节限定物品送掉。

## 住址和日程决定效率

送礼路线要顺路。买种子时顺便处理镇中心，钓鱼时处理海滩，下矿时处理山区，晚上可以考虑酒吧路线。雨天或节日时，村民日程可能变化，必要时少送几个人也比满地图乱跑好。

建议每周固定两到三天处理送礼，而不是每天强行全镇巡逻。这样不会挤压种地、钓鱼和矿洞时间。关系提升是长期收益，不能让它破坏基础经济。

## 后期礼物库存管理

中后期有动物产品、果树水果、料理和加工品后，礼物库存会稳定很多。此时可以按村民分箱或按礼物类型分箱。生日礼物单独标记，普通日礼物作为备用。若你开始追求全村关系，再逐步扩大覆盖面。

最终送礼路线要服务你的目标：解锁剧情、完成任务、提高关系或补全图鉴。先保证不误送关键物品，再谈效率最大化。

实际管理时，可以给礼物箱贴上三类规则：生日专用、日常安全、暂不送出。生日专用放已经确认喜好的物品；日常安全放容易补充的作物、花或料理；暂不送出放稀有鱼、矿物、社区中心样本和任务材料。这样即使你还没记住所有 NPC，也能避免把关键物品送错。

每周路线也要现实一点。周一到周五不必每天跑全镇，可以把送礼和原本要做的事合并：去皮埃尔买种子时顺路镇中心，去海边钓鱼时顺路码头，去矿洞时顺路山区。生日当天再单独安排。关系系统是长期收益，稳定比一次跑很多人更重要。

如果礼物库存不稳定，就先只维护少数目标村民。等果树、动物产品和料理稳定后，再扩大覆盖范围。送礼路线宁可少而准，不要为了刷心把一天核心生产节奏全部打乱。
`,
    coverImage: "/assets/game/36px-Rabbit's_Foot.png",
    featured: 0,
    categories: ["专题", "村民关系"],
    chapterChecks: [
      "每季第一天查看生日并准备礼物箱。|优先处理路线顺和礼物好准备的村民。|生日当天提前安排路线。",
      "送礼前确认物品不是社区中心、任务或制作材料。|礼物池按村民喜好判断，不只看价格。|第一份稀有物品不要乱送。",
      "买种子、钓鱼、下矿和酒吧路线顺路送礼。|每周固定几天处理，不全镇乱跑。|雨天和节日注意日程变化。",
      "中后期用动物产品、果树水果、料理和加工品稳定礼物库存。|生日礼物单独标记。|送礼服务剧情、任务和关系目标。"
    ]
  },
  {
    title: "星露谷物语新手完整指南",
    slug: "beginner-guide",
    summary: "从游戏第一天到姜岛和后期发展，按阶段串联第一周、春季赚钱、工具升级、矿洞、社区中心与温室解锁。",
    body: `# 星露谷物语新手完整指南

这是一条从新档开局走到中后期的完整成长路线。它不要求速通，也不要求每天照表操作，而是帮你判断当前最重要的目标：先稳定体力和现金流，再推进矿洞与社区中心，随后解锁温室、沙漠和姜岛。遇到具体问题时，可以从[新手成长路线](/guides/beginner)、[赚钱攻略](/guides/money-making)、[社区中心攻略](/guides/community-center)和[资源获取攻略](/guides/resources)继续查找。

## 游戏第一天

第一天先清理住宅附近的小范围土地，把初始种子全部种下并浇水，不要为了整齐把体力耗在大面积砍树和敲石头上。清理出来的木材先留给箱子，纤维、石头和树液也不要急着出售。完成播种后熟悉农场出口、公交站和小镇路线，顺路认识村民即可，不需要第一天跑完整张地图。

当天的目标是建立“浇水—整理背包—出门—回家存放”的循环。第一份陌生材料先保留，晚上把作物、采集物和矿洞材料分箱的习惯提前建立。若还不熟悉操作，宁可早点睡，也不要为了多砍几棵树耗尽体力。接下来按[第一周完整发展路线](/guides/year-one-first-week-complete-route)继续执行会更稳。

## 第一周规划

第一周重点是把种地、钓鱼、采集和矿洞四条线都启动起来。浇完作物后根据当天目标选择一项主活动：需要现金就钓鱼，需要材料就下矿，需要食物和木材就采集。背包升级很重要，但不要为了立刻购买背包卖掉社区中心样本和稀有材料；可以先读[新手背包升级与体力管理路线](/guides/beginner-backpack-and-energy-route)判断资金优先级。

矿洞开放后优先推进每五层的电梯节点，第一周不必追求深层。复活节前逐步积累草莓本金，同时准备稻草人、农田通道和每天能浇完的地块上限。周末复盘一次箱子与现金：是否留了春季作物、采集物和鱼类样本，是否有足够资金进入第二周，是否因为扩田导致每天上午都在浇水。

## 春季赚钱路线

春季现金流适合分成两段：复活节前用防风草、土豆、钓鱼和采集维持周转，复活节后用草莓承接整季收入。不要只看单个作物售价，还要计算种子成本、成熟天数、剩余收获次数和手浇压力。播种前可用[作物收益计算器](/tools/crop-profit)核对地块与预算，再参考[第一年春季赚钱路线](/guides/year-one-spring-money-route)安排每天的主要收入来源。

普通新手最稳的做法是保留一部分现金给背包、工具和矿洞食物，而不是把全部资金压进种子。第一份作物和鱼类先查用途，社区中心需要的样本单独放箱子。草莓数量以每天能稳定浇完为上限；如果上午已经没有时间出门，就停止扩田，改去准备洒水器材料。

## 工具升级顺序

工具升级没有唯一答案，但可以按“减少每日固定劳动”的原则排序。浇水壶适合在雨天前或季末送去升级，镐子直接影响矿洞推进和矿石获取，斧头关系硬木与秘密森林路线，锄头和垃圾桶通常可以稍后处理。升级前确认未来两天是否必须使用该工具，并保留足够现金与矿锭，不要把所有材料同时投入设备制作。

如果当前每天浇水最耗时间，先准备洒水器和浇水壶；如果卡在矿洞层数，优先镐子。具体矿石需求可以结合[洒水器解锁与矿石路线](/guides/sprinkler-unlock-and-ore-route)检查。每次升级只解决一个明确瓶颈，避免因为同时缺工具、现金和材料让农场停摆。

## 矿洞探索

下矿前清空背包，只带镐子、武器、食物和必要工具，并把目标写成一句话：推进电梯、补铜矿、刷铁矿、找煤炭或收集怪物材料。冲电梯时看到楼梯优先下层，不要为了清空每块石头错过时间；刷材料时则选择已经解锁、怪物压力可控的楼层段重复进入。

铜矿、铁矿、金矿、煤炭、晶球和怪物掉落都不要在用途不明时随手卖掉。前期先看[矿洞前 40 层准备与收益路线](/guides/mines-floor-40-preparation-route)，需要完整规划时再读[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)。回家后按矿石、晶球、怪物材料分类存放，下一次出门前先看真正缺什么。

## 社区中心路线

社区中心的关键不是一次完成全部收集包，而是避免错过季节窗口。每季第一天打开[社区中心进度清单](/tools/community-center)，先标出当季作物、采集物、雨天鱼和夜间鱼；全年都能补的矿物、工匠品和金库可以稍后处理。第一份陌生物品先保留，确认不献祭、不做任务后再出售。

前期优先关注工艺室、茶水间和鱼缸，因为它们最容易受到季节限制。雨天先查[鱼类查询器](/tools/fish)，播种前查作物图鉴，季末再做一次补漏。更完整的房间优先级和保留逻辑可以从[社区中心攻略](/guides/community-center)继续阅读，不必为了追求第一年完成而破坏基础经济。

## 温室解锁

温室解锁前先准备洒水器、种子和布局，不要等修复完成后才临时决定种什么。社区中心路线需要推进茶水间相关收集包，另一条发展路线则侧重现金投入；无论选择哪条，都要保证解锁当天不会掏空建筑、工具和日常种植所需资金。临近完成时先整理种子箱和肥料箱。

温室中间地块适合长期作物、种子扩繁和任务作物分区，边缘空间再规划果树。远古水果和杨桃的价值取决于小桶容量，不是种得越多就越好。先读[温室作物与加工收益路线](/guides/greenhouse-crops-processing-route)，再根据设备数量决定扩大种植还是补树脂、木材与小桶。

## 姜岛开启

姜岛属于中后期内容，通常应在社区中心主线、基础工具、稳定收入和战斗补给已经成形后推进。出发前准备食物、武器、背包空间和明确目标，把金色核桃、岛屿农场、火山地牢和特殊鱼类分批处理。第一次到岛上以开路和认识区域为主，不需要一天完成所有探索。

岛屿路线很容易因为目标过多而分散。每次只设一个核心任务，例如补核桃、推进火山、整理岛屿农场或收集鱼类，并参考[姜岛解锁与金色核桃收集路线](/guides/ginger-island-golden-walnut-route)记录已经完成的区域。稀有鱼和岛屿资源先保留，确认收藏、制作与任务用途后再出售。

## 后期发展

后期目标从“每天活下来”转为“让生产链稳定运行”。检查温室和姜岛作物产量是否超过小桶、罐头瓶与箱子容量，检查动物、树脂、矿石和硬木是否形成固定补给，并为精通、齐先生任务和图鉴补全预留时间。不要只扩地块，设备、通道和收纳跟不上会让收益停在仓库里。

可以把每周分成收获加工日、矿洞资源日、姜岛探索日和关系任务日，留出一天处理临时事件。完成基础路线后，从[资源获取攻略](/guides/resources)补材料短板，再读[1.6 精通系统详解](/guides/mastery-system-guide-1-6)安排长期目标。后期没有唯一毕业答案，稳定、可维护并符合自己的玩法就是正确路线。`,
    coverImage: "/assets/game/36px-Farming.png",
    featured: 1,
    categories: ["新手入门", "专题"],
    chapterChecks: [
      "种下初始种子并只清理小范围土地。|木材优先做箱子，陌生材料先保留。|熟悉路线后按时回家。",
      "每天只选一个主要活动。|推进基础钓鱼与矿洞电梯。|周末复盘样本、现金和浇水压力。",
      "复活节前稳现金，节后用草莓承接。|播种前计算成本与收获次数。|不把全部资金压进种子。",
      "按当前最大瓶颈升级工具。|雨天或季末安排浇水壶。|矿锭和现金保留安全余量。",
      "下矿前写明本次目标。|冲层和刷材料使用不同节奏。|回家后按材料类型分类。",
      "每季第一天标出限定物品。|第一份陌生物品先保留。|季末复盘雨天鱼与作物缺口。",
      "解锁前准备洒水器、种子和布局。|长期作物与任务作物分区。|产量和加工设备容量同步扩张。",
      "每次上岛只设一个核心目标。|核桃、火山、农场与钓鱼分批推进。|稀有资源确认用途后再处理。",
      "用固定周计划维护生产链。|发现积压先扩设备而不是扩田。|用资源攻略补齐长期材料短板。"
    ]
  },
  {
    title: "新手成长路线",
    slug: "beginner",
    summary: "按开局、第一周、四季与关键解锁整理新手攻略入口，适合从零建立第一年发展节奏。",
    body: `# 新手成长路线

本页是新手攻略的专题聚合入口。建议先读[星露谷物语新手完整指南](/guides/beginner-guide)建立全局顺序，再根据当前季节和卡点进入对应文章。路线重点是稳定而不是极限：先让每天的种地、钓鱼、下矿和整理形成循环，再逐步扩大农场。

## 开局第一天到第一周

刚开档先处理最小农田、箱子、背包和基础现金流，不要把体力花在清空整个农场。按[第一周完整发展路线](/guides/year-one-first-week-complete-route)建立每日节奏，再用[新手背包升级与体力管理路线](/guides/beginner-backpack-and-energy-route)判断背包、食物与种子之间的资金优先级。第一份陌生物品先留，避免在社区中心开放后才发现关键样本已经卖掉。

第一周只需要启动四条线：作物能稳定浇完、钓鱼能提供现金、矿洞能打开电梯、采集能补食物和材料。每天设一个主要活动，不追求把所有系统同时做满。如果日程仍然混乱，可先看[新手工具优先使用路线](/guides/tool-first-new-player-workflow)，学会在播种、雨天和季末使用对应工具。

## 春夏秋冬成长节奏

春季负责启动资金与社区中心样本，可从[春季专题](/guides/spring-season-topic-guide)和[第一年春季赚钱路线](/guides/year-one-spring-money-route)开始。夏季重点转向蓝莓、洒水器、铁矿和鱼缸窗口，参考[夏季专题](/guides/summer-season-topic-guide)。秋季处理南瓜、温室前置与第二年资金，进入[秋季专题](/guides/fall-season-topic-guide)。

冬季不是空档，而是整理箱子、集中下矿、补鱼类与准备第二年的阶段。[冬季专题](/guides/winter-season-topic-guide)适合安排日常，[冬季整理与第二年准备路线](/guides/winter-prep-year-two-route)适合做季末验收。每季开始和结束各复盘一次，就能避免把所有问题拖到下一年。

## 种地钓鱼与矿洞基础

播种前打开[作物收益计算器](/tools/crop-profit)，输入季节剩余天数、预算与地块，不要只看最高售价。钓鱼前打开[鱼类查询器](/tools/fish)，先选季节和天气，再看时间与地点。矿洞则要先决定冲电梯还是刷材料，前 40 层可以参考[矿洞前 40 层准备与收益路线](/guides/mines-floor-40-preparation-route)。

这三条线互相支持：钓鱼提供早期现金，矿洞提供洒水器和工具材料，作物提供稳定收入与社区中心样本。任何一条占满整天都会挤压其他进度。发现每天上午都在浇水时停止扩田，发现下矿没有收获时先明确缺什么，发现钓鱼总空跑时先检查条件而不是换地点碰运气。

## 社区中心与关键解锁

社区中心开放后用[社区中心进度清单](/tools/community-center)保存缺口，把作物、采集、鱼类、矿物和动物产品分箱。优先处理会随季节消失的机会，全年可补内容排后。完整房间顺序从[社区中心攻略](/guides/community-center)进入，鱼缸可单独查看[社区中心鱼缸收集路线](/guides/community-center-fish-tank-route)。

温室解锁后不要立刻把所有地块塞满，先看[温室作物与加工收益路线](/guides/greenhouse-crops-processing-route)规划洒水器、种子与小桶容量。沙漠、秘密森林、下水道和姜岛也应按前置逐步开放，遇到材料卡点时转到[资源获取攻略](/guides/resources)，不要在未解锁区域反复寻找。

## 常见误区与下一阶段

新手最常见的问题不是少赚一天，而是误卖限定物品、无上限扩田、下矿没有目标、工具升级时机错误和为了送礼跑遍全镇。[新手常见 20 个误区](/guides/beginner-common-mistakes)可以作为季末检查表，[第一年新手路线总览](/guides/beginner-year-one-route-overview)则适合复盘四季发展是否失衡。

当温室、基础加工、工具和社区中心进度稳定后，就可以转向姜岛、精通、全图鉴和长期加工。下一步不必同时做完所有后期内容，先选择一个主目标，再从[赚钱攻略](/guides/money-making)补现金流或从资源攻略补材料。成长路线的结束不是固定日期，而是你已经能根据目标安排自己的每周节奏。`,
    coverImage: "/assets/game/36px-Mixed_Seeds.png",
    featured: 1,
    categories: ["新手入门", "专题"],
    chapterChecks: [
      "第一周先启动作物、钓鱼、矿洞和采集。|每天只设一个主要活动。|第一份陌生物品先保留。",
      "春夏秋冬各设阶段目标。|每季开始与结束各复盘一次。|冬季用于整理、补漏和第二年准备。",
      "作物、钓鱼和矿洞互相提供现金与材料。|扩田前检查浇水压力。|出门前先确认当天目标。",
      "季节限定献祭优先。|温室解锁前准备布局和设备。|区域未解锁时先处理前置。",
      "用误区清单做季末检查。|后期一次只推进一个主目标。|现金和材料短板分开解决。"
    ]
  },
  {
    title: "赚钱攻略",
    slug: "money-making",
    summary: "聚合作物、钓鱼、加工与四季现金流路线，帮助新手按阶段选择稳健收益方式。",
    body: `# 赚钱攻略

星露谷的赚钱路线会随季节、工具、洒水器和加工设备变化。本专题不追求单一最高利润，而是把现金流、体力、时间和解锁进度一起考虑。开始前可用[作物收益计算器](/tools/crop-profit)核对当前条件，再从对应季节路线继续阅读。

## 春季启动资金

春季前半段用防风草、土豆、钓鱼和采集保持周转，重点是为背包、工具、矿洞食物和复活节草莓准备资金。[第一年春季赚钱路线](/guides/year-one-spring-money-route)提供完整日程，[第一周完整发展路线](/guides/year-one-first-week-complete-route)适合还没建立现金循环的新档。不要把所有金币投入成熟较慢的作物，必须保留应急资金。

复活节后草莓可以承担主要现金流，但数量仍受浇水时间限制。播种日越晚，剩余收获次数越少；第一年节日当天买种时尤其要先算地块和体力。钓鱼稳定的玩家可少种一点，把下午留给海滩或河流；钓鱼不熟练的玩家则用小规模作物保持可预测收入。

## 夏秋稳定现金流

夏季常见组合是蓝莓负责重复收获，甜瓜承担高价值与社区中心样本，少量啤酒花为后续加工做准备。具体比例取决于洒水器与小桶数量，可查看[第一年夏季赚钱路线](/guides/year-one-summer-money-route)。没有自动化时不要盲目扩大蓝莓地块，浇水占满上午会减少矿石、鱼类和任务收益。

秋季可在蔓越莓与南瓜之间平衡持续现金和单次回款，并为温室、动物建筑与第二年准备保留预算。[第一年秋季赚钱路线](/guides/year-one-fall-money-route)适合安排作物，[秋季专题](/guides/fall-season-topic-guide)则同时覆盖社区中心与温室前置。南瓜和玉米等关键样本先保留，不能为了当天金币拖慢全年解锁。

## 钓鱼与矿洞收益

钓鱼是前期最灵活的现金来源，但真正效率来自少跑空路。每天出门前用[鱼类查询器](/tools/fish)检查季节、天气、时间和地点；如果目标只是赚钱，优先选择路线近、上钩稳定的鱼，而不是全天硬追高难度鱼。雨天和夜间限定鱼先判断社区中心与收藏用途，重复品再出售。

矿洞更像材料收益，不应只按当天出货箱金币计算。铜、铁、金、煤炭和怪物掉落会减少工具、洒水器与设备的后续成本。[矿洞楼层资源与掉落路线](/guides/mines-drops-and-floor-resource-route)适合按目标选层。前期把关键材料卖掉换短期现金，通常会在几天后以更高时间成本重新刷取。

## 加工设备与温室

进入中期后，收益瓶颈会从地块数量转为加工设备容量。先统计每周作物产量，再决定增加小桶、罐头瓶还是直接出售；库存持续积压时应先扩设备和树脂供应，不是继续无上限扩田。[温室作物与加工收益路线](/guides/greenhouse-crops-processing-route)会帮助你比较远古水果、杨桃和其他长期作物。

远古水果适合稳定扩种和低频维护，杨桃适合有足够本金与小桶时集中加工。第一批远古水果往往先进入种子生产器，杨桃则要考虑种子成本与周转。温室和姜岛都应保留任务作物区，不要让单一高价作物锁死全部空间。

## 资金分配与后期收益

赚钱的目的不是让金币停在账户，而是换取更稳定的时间与产能。每季把预算拆成种子、工具、建筑、动物、设备和应急现金，优先解决当前最大瓶颈。背包、洒水器与通道改善能直接节省时间，往往比多种一片作物更早产生长期回报。

后期可结合[资源获取攻略](/guides/resources)检查木材、硬木、矿石、树脂和电池组供应，再决定扩大加工链。若只是追求最高单价而忽略收获、装填和收纳时间，生产链会越来越累。稳定的周计划、匹配的设备容量和足够的材料库存，才是可持续赚钱路线。`,
    coverImage: "/assets/game/36px-Gold_Bar.png",
    featured: 1,
    categories: ["农场经营", "专题"],
    chapterChecks: [
      "春季先保证周转和草莓本金。|种子之外保留工具与背包预算。|地块不超过手浇上限。",
      "夏季平衡蓝莓、甜瓜和加工准备。|秋季兼顾南瓜、温室与第二年。|关键样本先留后卖。",
      "钓鱼出发前核对条件。|矿洞材料按长期成本计算。|限定鱼与稀有材料先确认用途。",
      "每周产量与设备容量同步。|库存积压先扩设备。|温室保留扩种、现金和任务分区。",
      "预算拆成种子、工具、建筑、设备和应急金。|优先解决时间瓶颈。|后期维持稳定材料供应。"
    ]
  },
  {
    title: "社区中心攻略",
    slug: "community-center",
    summary: "聚合房间优先级、四季物品保留、鱼缸路线与温室解锁，帮助玩家按季节推进社区中心。",
    body: `# 社区中心攻略

社区中心最难的不是物品数量，而是季节、天气和解锁窗口。本专题把收集包拆成可执行的检查顺序：每季开始标记限定物品，雨天处理鱼类窗口，季末补漏，全年可得材料放到后面。建议先打开[社区中心进度清单](/tools/community-center)保存当前状态。

## 前期房间优先级

前期优先关注工艺室、茶水间和鱼缸。采集物、作物和鱼类容易因季节变化错过，锅炉房可以随着矿洞自然推进，金库则随现金流处理。详细顺序可看[社区中心前期优先完成路线](/guides/early-community-center-priority-route)，不要为了立刻完成某个全年可补项目而牺牲当季限定机会。

布告栏通常涉及动物产品、料理、工匠品和多系统物品，更适合作为中期目标。遇到陌生作物、鱼类、动物产品或矿物时先留一份，按类别放进样本箱。每周固定一次清单核对，比每天在所有房间之间来回切换更容易坚持。

## 四季物品保留

每季第一天把清单筛到当前季节，先记录作物、采集和鱼类。春季保留基础作物与雨天鱼，夏季处理高价值作物和海鱼窗口，秋季注意南瓜、玉米与温室前置，冬季集中补矿洞、鱼类和动物产品。[社区中心四季物品保留清单](/guides/community-center-seasonal-items-checklist)适合做完整复盘。

箱子管理决定清单能否执行。作物、鱼类、采集物、矿物、动物产品和工匠品最好分开存放，第一份陌生物品放样本箱，重复品再出售。[春夏秋必留物品清单](/guides/seasonal-items-to-keep)可以减少误卖，但最终仍以当前清单缺口为准。

## 鱼缸与天气窗口

鱼缸最容易卡在雨天鱼、夜间鱼、特殊地点鱼和跨季鱼。遇到雨天先用[鱼类查询器](/tools/fish)筛当前季节与天气，再按时间和地点安排路线。第一条目标鱼优先献祭或存放，不能因为售价高直接卖掉。[社区中心鱼缸收集路线](/guides/community-center-fish-tank-route)会把河鱼、湖鱼、海鱼与特殊鱼分开说明。

如果钓鱼等级不足，不必在一次雨天硬拼所有高难鱼。先完成容易的目标、准备增益料理和浮标，再利用下次窗口补齐。季末前把缺口分成“本季还能拿”和“必须等下一季”，这样即使无法第一年完成，也不会重复错过同一条鱼。

## 茶水间与温室

茶水间关系温室解锁，作物、品质作物、动物产品和工匠品需要跨系统准备。播种前先核对收集包，不要等收获后才发现缺少某个季节作物。南瓜、玉米、甜瓜等样本要单独留存，高品质要求则需要提前规划肥料、地块与收获数量。

接近完成时提前准备温室洒水器、种子和布局，解锁后才能立刻投入使用。[温室解锁与全年种植布局](/guides/greenhouse-unlock-year-round-layout)适合处理空间，[温室作物与加工收益路线](/guides/greenhouse-crops-processing-route)适合处理种植与设备。温室是社区中心路线的重要回报，不应解锁后长期空置。

## 季末补漏与完成节奏

每季倒数几天做一次总检查：当前作物是否还有成熟时间，雨天鱼是否已经获得，采集物是否入箱，节日或旅行货车是否还有补救机会。全年可补项目可以推迟，跨季等待的项目必须优先。清单给出缺口，图鉴与工具负责告诉你今天去哪里。

普通新手不需要为了第一年完成牺牲所有现金和探索。只要每季开始、雨天和季末固定检查，社区中心进度就会稳定收敛。完成一个房间后再根据奖励调整路线；温室、矿车与巴士等关键解锁会逐步改善时间和资源效率，最终让剩余收集包更容易处理。`,
    coverImage: "/assets/game/36px-Bundle_Purple.png",
    featured: 1,
    categories: ["新手入门", "专题"],
    chapterChecks: [
      "优先处理季节明显的房间。|锅炉房随矿洞推进。|布告栏作为中期多系统目标。",
      "每季第一天筛当前季节。|第一份陌生物品放样本箱。|作物、鱼类与材料分箱管理。",
      "雨天先查鱼类条件。|目标鱼优先献祭或保留。|季末区分本季可补与跨季等待。",
      "播种前核对茶水间需求。|高品质样本提前规划。|温室解锁前准备洒水器与种子。",
      "每季末检查成熟时间和限定窗口。|全年可补项目排后。|不为速通牺牲全部现金与探索。"
    ]
  },
  {
    title: "资源获取攻略",
    slug: "resources",
    summary: "聚合矿石、煤炭、木材、硬木、稀有鱼与后期材料路线，按解锁阶段解决资源短板。",
    body: `# 资源获取攻略

资源短缺通常不是因为地图上没有材料，而是没有把目标、地点和刷新节奏对应起来。本专题按基础材料、矿洞资源、解锁材料和后期稀有内容整理入口。出门前先看箱子并写下本次目标，不要带着“什么都缺”的状态随机跑图。

## 木材石头与基础材料

木材、石头、纤维和树液贯穿箱子、建筑、道路、肥料与设备制作。前期只清理农场当前要使用的区域，保留树种和可持续采集空间；为了整齐一次砍光会消耗大量体力，也会让后续木材供应不稳定。建立材料箱后为下一座建筑和下一批设备设定最低库存，超过部分再用于装饰。

煤炭虽然来自矿洞和部分加工，但长期会被熔炉、罐头瓶与其他设备持续消耗，不建议当作普通掉落出售。纤维和树液单价不高，却常在大批量制作时突然短缺。新手应把“价格低”与“没有用途”分开判断，第一批材料先保留，确定近期没有制作需求后再处理。

## 矿石晶球与怪物掉落

矿洞资源要按楼层和目标获取。冲电梯时优先到每五层节点，刷铜、铁、金或怪物材料时再选择熟悉楼层重复进入。[矿洞楼层资源与掉落路线](/guides/mines-drops-and-floor-resource-route)适合前期查找，[矿洞 1-120 层资源与怪物掉落路线](/guides/mines-floor-120-resource-monster-route)适合完整规划。

晶球建议积累一批后集中处理，怪物掉落则按制作、任务与收藏分箱。史莱姆泥、蝙蝠翅膀、精华和骨头碎片等材料看似常见，批量制作时会消耗很快。每次下矿回家后记录真正缺少的材料，下次只为一个明确目标选楼层，效率会比随机清层稳定。

## 洒水器工具与建筑材料

铜锭、铁锭、金锭和煤炭同时服务工具、洒水器与设备，最容易发生资源冲突。准备升级工具前先保留未来几天的制作需求，准备扩大农田前先确认洒水器材料是否齐全。[洒水器解锁与矿石路线](/guides/sprinkler-unlock-and-ore-route)可以帮助你决定当前阶段优先刷哪种矿石。

木材、石头、硬木和金币则关系鸡舍、畜棚、马厩和房屋升级。不要在材料刚够时同时开启多个建筑计划，先完成能解决最大瓶颈的一项。建筑等待期间继续补下一批资源，避免罗宾完成后农场再次停在零库存。

## 特殊区域与稀有资源

硬木、特殊鱼、稀有矿物和区域掉落往往有地点前置。秘密森林需要对应工具能力，沙漠依赖巴士，变种鲤鱼依赖下水道，姜岛鱼类与火山材料则要先推进岛屿路线。页面显示某项资源时，先确认区域是否已经解锁，再判断钓鱼、战斗或采集方法。

传奇鱼和稀有鱼不适合当作普通现金来源。挑战前用[鱼类查询器](/tools/fish)确认季节、天气、时间与地点，再从[钓鱼专题](/guides/fishing-topic-guide)准备料理和渔具。第一条传奇鱼、矿井鱼或姜岛特殊鱼优先保留，收藏和鱼塘需求确认后再决定后续用途。

## 温室姜岛与后期补给

温室和姜岛开启后，资源瓶颈会转向种子扩繁、小桶、树脂、矿石与加工空间。远古水果和杨桃只有在设备容量匹配时才能形成稳定收益；库存持续积压时，应该先补木材、树脂和设备，而不是继续扩大种植。[温室作物与加工收益路线](/guides/greenhouse-crops-processing-route)适合核对生产链。

姜岛探索则需要食物、武器、背包空间和明确的单日目标。[姜岛解锁与金色核桃收集路线](/guides/ginger-island-golden-walnut-route)可以减少重复跑路。后期每周保留一个资源日，轮换补矿石、硬木、树脂和特殊掉落，比材料耗尽后连续几天救火更容易维护。

## 资源清单与长期规划

建议把库存分为日常消耗、下一项目、稀有保留三层。日常消耗维持熔炉、食物和基础制作；下一项目按建筑或设备列出明确数量；稀有保留存放第一份特殊鱼、稀有矿物、任务物品和限定材料。箱子标签越清晰，越不容易误卖或重复刷取。

每周复盘一次材料缺口，并把它与[赚钱攻略](/guides/money-making)分开处理：缺金币时找现金流，缺矿石时安排矿洞，缺硬木时走固定采集路线，缺加工能力时补设备供应链。资源规划的目标不是囤满所有箱子，而是让下一项升级不会因为一种基础材料突然中断。`,
    coverImage: "/assets/game/36px-Foraging_Skill_Icon.png",
    featured: 1,
    categories: ["进阶攻略", "专题"],
    chapterChecks: [
      "只清理当前使用区域。|为建筑和设备设置最低库存。|低价基础材料不等于没有用途。",
      "冲电梯与刷材料分开执行。|晶球集中处理。|怪物掉落按制作、任务和收藏分箱。",
      "矿锭在工具、洒水器和设备之间分配。|建筑一次解决一个瓶颈。|等待期间补下一批材料。",
      "先确认特殊区域是否解锁。|稀有鱼挑战前核对全部条件。|第一份传奇或特殊资源优先保留。",
      "温室与姜岛生产量匹配设备容量。|每周保留一个资源日。|库存积压时先补设备供应链。",
      "库存分日常、下一项目和稀有保留。|金币与材料短板分开解决。|每周复盘一次明确缺口。"
    ]
  }
];
