...
const internalLinkLabels = new Map([
  ...
  ["/guides/sprinkler-unlock-and-ore-route", "洒水器解锁与矿石路线"],
  ["/guides/community-center-fish-tank-route", "社区中心鱼缸收集路线"],
  ["/guides/seasonal-items-to-keep", "春夏秋必留物品清单"],
  ["/guides/beginner-backpack-and-energy-route", "新手背包升级与体力管理路线"],
  ["/guides/year-one-fall-money-route", "第一年秋季赚钱路线"],
  ["/guides/coop-barn-animal-products-route", "鸡舍畜棚与动物产品路线"],
  ["/guides/greenhouse-crops-processing-route", "温室作物与加工路线"],
  ["/guides/quest-board-special-orders-route", "任务板与特别订单路线"],
  ["/guides/winter-prep-year-two-route", "冬季准备与第二年路线"],
  ["/guides/villager-gift-birthday-recommendation", "村民礼物与生日推荐"],
  ["/guides/mines-drops-and-floor-resource-route", "矿洞掉落与楼层资源路线"],
  ["/guides/beginner-year-one-route-overview", "第一年新手路线总览"],
  ...
  ["/guides/all-villager-birthdays-and-gifts", "\u5168\u6751\u6c11\u751f\u65e5\u4e0e\u793c\u7269\u63a8\u8350"],
  ["/guides/mines-floor-120-resource-monster-route", "\u77ff\u6d1e 1-120 \u5c42\u8d44\u6e90\u4e0e\u602a\u7269\u6389\u843d\u8def\u7ebf"],
  ["/guides/community-center-seasonal-items-checklist", "\u793e\u533a\u4e2d\u5fc3\u56db\u5b63\u7269\u54c1\u4fdd\u7559\u6e05\u5355"],
  ["/guides/beginner-common-mistakes", "\u65b0\u624b\u5e38\u89c1 20 \u4e2a\u8bef\u533a"],
  ...
  ["/guides/community-center-topic-guide", "\u793e\u533a\u4e2d\u5fc3\u4e13\u9898"],
  ["/guides/fishing-topic-guide", "\u9493\u9c7c\u4e13\u9898"],
  ["/guides/mines-topic-guide", "\u77ff\u6d1e\u4e13\u9898"],
  ...
  ["/wiki/festivals", "节日活动"],
  ["/wiki/locations", "地点地图"],
  ["/wiki/crops/coffee-bean", "咖啡豆"],
  ["/wiki/items/apple", "苹果"],
  ["/wiki/items/banana", "香蕉"],
  ["/wiki/items/orange", "橙子"],
  ["/wiki/items/peach", "桃子"],
  ["/wiki/items/pomegranate", "石榴"],
